...

{
     ...
     * <ul>
     * <li>full name: selltype.selltypeid
     * <li>column size: 4
     ...
     */
    public void copy(SelltypeBean bean) {
    ...
    public String toString() {
        return   "\n[selltype] "
                 + "\n - selltype.selltypeid = " + (selltypeid_is_initialized ? ("[" + (selltypeid == null ? null : selltypeid.toString()) + "]") : "not initialized") + ""
                 + "\n - selltype.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
            ;
    }
