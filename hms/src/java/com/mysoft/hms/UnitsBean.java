...

{
     ...
     */
    public void copy(UnitsBean bean) {
    ...
    public String toString() {
        return   "\n[units] "
                 + "\n - units.unitsid = " + (unitsid_is_initialized ? ("[" + (unitsid == null ? null : unitsid.toString()) + "]") : "not initialized") + ""
                 + "\n - units.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
                 + "\n - units.status = " + (status_is_initialized ? ("[" + (status == null ? null : status.toString()) + "]") : "not initialized") + ""
                 + "\n - units.color = " + (color_is_initialized ? ("[" + (color == null ? null : color.toString()) + "]") : "not initialized") + ""
            ;
    }
