...
public class VTariffRoomtypeTarifftypeSeasonAgentBean
// extends+ 
...
// extends- 
{
     ...
     */
    VTariffRoomtypeTarifftypeSeasonAgentBean()
    {
    }
     ...
     * <ul>
     * <li>full name: v_tariff_roomtype_tarifftype_season_agent.tid
     * <li>column size: 4
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: v_tariff_roomtype_tarifftype_season_agent.rid
     * <li>column size: 4
     * <li>jdbc type returned by the driver: Types.INTEGER
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: v_tariff_roomtype_tarifftype_season_agent.sid
     * <li>column size: 4
     * <li>jdbc type returned by the driver: Types.INTEGER
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: v_tariff_roomtype_tarifftype_season_agent.agentid
     * <li>column size: 8
     ...
     */
    public void copy(VTariffRoomtypeTarifftypeSeasonAgentBean bean) {
        setTid(bean.getTid());
        setRid(bean.getRid());
        setSid(bean.getSid());
    ...
    public String toString() {
        return   "\n[v_tariff_roomtype_tarifftype_season_agent] "
                 + "\n - v_tariff_roomtype_tarifftype_season_agent.tid = " + (tid_is_initialized ? ("[" + (tid == null ? null : tid.toString()) + "]") : "not initialized") + ""
                 + "\n - v_tariff_roomtype_tarifftype_season_agent.rid = " + (rid_is_initialized ? ("[" + (rid == null ? null : rid.toString()) + "]") : "not initialized") + ""
                 + "\n - v_tariff_roomtype_tarifftype_season_agent.sid = " + (sid_is_initialized ? ("[" + (sid == null ? null : sid.toString()) + "]") : "not initialized") + ""
                 + "\n - v_tariff_roomtype_tarifftype_season_agent.agentid = " + (agentid_is_initialized ? ("[" + (agentid == null ? null : agentid.toString()) + "]") : "not initialized") + ""
            ;
    }
