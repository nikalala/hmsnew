...
// extends- 
{
     ...
     * <ul>
     * <li>full name: nationality.nationalityid
     * <li>column size: 10
     ...
     */
    public void copy(NationalityBean bean) {
    ...
    public String toString() {
        return   "\n[nationality] "
                 + "\n - nationality.nationalityid = " + (nationalityid_is_initialized ? ("[" + (nationalityid == null ? null : nationalityid.toString()) + "]") : "not initialized") + ""
                 + "\n - nationality.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
            ;
    }
