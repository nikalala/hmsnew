...

{
     ...
     */
    public void copy(PayoutBean bean) {
    ...
    public String toString() {
        return   "\n[payout] "
                 + "\n - payout.payoutid = " + (payoutid_is_initialized ? ("[" + (payoutid == null ? null : payoutid.toString()) + "]") : "not initialized") + ""
                 + "\n - payout.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
                 + "\n - payout.regbyid = " + (regbyid_is_initialized ? ("[" + (regbyid == null ? null : regbyid.toString()) + "]") : "not initialized") + ""
                 + "\n - payout.regdate = " + (regdate_is_initialized ? ("[" + (regdate == null ? null : regdate.toString()) + "]") : "not initialized") + ""
                 + "\n - payout.active = " + (active_is_initialized ? ("[" + (active == null ? null : active.toString()) + "]") : "not initialized") + ""
                 + "\n - payout.deteted = " + (deteted_is_initialized ? ("[" + (deteted == null ? null : deteted.toString()) + "]") : "not initialized") + ""
            ;
    }
