...

{
    ...
    private String flag;
    private boolean flag_is_modified = false;
    private boolean flag_is_initialized = false;
     ...
     * <ul>
     * <li>full name: country.countryid
     * <li>default value: nextval('countryid_seq'::regclass)
     * <li>column size: 10
     ...
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to flag
     */
    public void setFlag(String newVal) {
        if ((newVal != null && this.flag != null && (newVal.compareTo(this.flag) == 0)) || 
            (newVal == null && this.flag == null && flag_is_initialized)) {
            return; 
        } 
        this.flag = newVal; 
    ...
    /**
     * Determines if the flag has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isFlagModified() {
        return flag_is_modified; 
    }

    /**
     * Determines if the flag has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isFlagInitialized() {
        return flag_is_initialized; 
    }
     ...
     */
    public void copy(CountryBean bean) {
    ...
    public String toString() {
        return   "\n[country] "
                 + "\n - country.countryid = " + (countryid_is_initialized ? ("[" + (countryid == null ? null : countryid.toString()) + "]") : "not initialized") + ""
                 + "\n - country.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
                 + "\n - country.code = " + (code_is_initialized ? ("[" + (code == null ? null : code.toString()) + "]") : "not initialized") + ""
                 + "\n - country.ext = " + (ext_is_initialized ? ("[" + (ext == null ? null : ext.toString()) + "]") : "not initialized") + ""
                 + "\n - country.flag = " + (flag_is_initialized ? ("[" + (flag == null ? null : flag.toString()) + "]") : "not initialized") + ""
            ;
    }
