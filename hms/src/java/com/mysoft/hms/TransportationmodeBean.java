...
// extends- 
{
     ...
     * <ul>
     * <li>full name: transportationmode.transportationmodeid
     * <li>column size: 10
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: transportationmode.name
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: transportationmode.regbyid
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: transportationmode.active
     * <li>comments: აქტიური
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: transportationmode.deteted
     * <li>comments: წაშლილი
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: transportationmode.regdate
     ...
     */
    public void copy(TransportationmodeBean bean) {
    ...
    public String toString() {
        return   "\n[transportationmode] "
                 + "\n - transportationmode.transportationmodeid = " + (transportationmodeid_is_initialized ? ("[" + (transportationmodeid == null ? null : transportationmodeid.toString()) + "]") : "not initialized") + ""
                 + "\n - transportationmode.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
                 + "\n - transportationmode.regbyid = " + (regbyid_is_initialized ? ("[" + (regbyid == null ? null : regbyid.toString()) + "]") : "not initialized") + ""
                 + "\n - transportationmode.active = " + (active_is_initialized ? ("[" + (active == null ? null : active.toString()) + "]") : "not initialized") + ""
                 + "\n - transportationmode.deteted = " + (deteted_is_initialized ? ("[" + (deteted == null ? null : deteted.toString()) + "]") : "not initialized") + ""
                 + "\n - transportationmode.regdate = " + (regdate_is_initialized ? ("[" + (regdate == null ? null : regdate.toString()) + "]") : "not initialized") + ""
            ;
    }
