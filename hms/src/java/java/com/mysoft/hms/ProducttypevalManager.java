...

{
    ...
    public ProducttypevalBean loadByPrimaryKey(Long productpropertyid, java.util.Date valuedate) throws SQLException
    {
        ...
        try 
        {
            ...
            if (valuedate == null) ps.setNull(2, Types.DATE); else ps.setDate(2, new java.sql.Date(valuedate.getTime()));
    ...
    public ProducttypevalBean save(ProducttypevalBean pObject) throws SQLException
    {
        ...
        try
        {
            ...
            { // SAVE 
                ...
                if (pObject.isValuedateModified()) {
                    if (pObject.getValuedate() == null) ps.setNull(++_dirtyCount, Types.DATE); else ps.setDate(++_dirtyCount, new java.sql.Date(pObject.getValuedate().getTime()));
                }
