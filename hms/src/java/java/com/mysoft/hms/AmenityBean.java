...

{
     ...
     * <ul>
     * <li>full name: amenity.amenityid
     * <li>column size: 10
     ...
     */
    public void copy(AmenityBean bean) {
    ...
    public String toString() {
        return   "\n[amenity] "
                 + "\n - amenity.amenityid = " + (amenityid_is_initialized ? ("[" + (amenityid == null ? null : amenityid.toString()) + "]") : "not initialized") + ""
                 + "\n - amenity.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
                 + "\n - amenity.type = " + (type_is_initialized ? ("[" + (type == null ? null : type.toString()) + "]") : "not initialized") + ""
                 + "\n - amenity.ord = " + (ord_is_initialized ? ("[" + (ord == null ? null : ord.toString()) + "]") : "not initialized") + ""
                 + "\n - amenity.regbyid = " + (regbyid_is_initialized ? ("[" + (regbyid == null ? null : regbyid.toString()) + "]") : "not initialized") + ""
                 + "\n - amenity.regdate = " + (regdate_is_initialized ? ("[" + (regdate == null ? null : regdate.toString()) + "]") : "not initialized") + ""
                 + "\n - amenity.active = " + (active_is_initialized ? ("[" + (active == null ? null : active.toString()) + "]") : "not initialized") + ""
                 + "\n - amenity.deleted = " + (deleted_is_initialized ? ("[" + (deleted == null ? null : deleted.toString()) + "]") : "not initialized") + ""
            ;
    }
