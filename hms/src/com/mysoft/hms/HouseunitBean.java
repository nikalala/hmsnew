...

{
     ...
     * <ul>
     * <li>full name: houseunit.houseunitid
     * <li>column size: 10
     ...
     */
    public void copy(HouseunitBean bean) {
    ...
    public String toString() {
        return   "\n[houseunit] "
                 + "\n - houseunit.houseunitid = " + (houseunitid_is_initialized ? ("[" + (houseunitid == null ? null : houseunitid.toString()) + "]") : "not initialized") + ""
                 + "\n - houseunit.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
                 + "\n - houseunit.regbyid = " + (regbyid_is_initialized ? ("[" + (regbyid == null ? null : regbyid.toString()) + "]") : "not initialized") + ""
                 + "\n - houseunit.regdate = " + (regdate_is_initialized ? ("[" + (regdate == null ? null : regdate.toString()) + "]") : "not initialized") + ""
                 + "\n - houseunit.active = " + (active_is_initialized ? ("[" + (active == null ? null : active.toString()) + "]") : "not initialized") + ""
                 + "\n - houseunit.deteted = " + (deteted_is_initialized ? ("[" + (deteted == null ? null : deteted.toString()) + "]") : "not initialized") + ""
            ;
    }
