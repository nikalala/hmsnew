...

{
     ...
     * <ul>
     * <li>full name: vipstatus.vipstatusid
     * <li>default value: nextval('vipstatus_vipstatusid_seq'::regclass)
     * <li>column size: 10
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: vipstatus.name
     * <li>default value: nextval('vipstatus_name_seq'::regclass)
     * <li>column size: 10
     * <li>jdbc type returned by the driver: Types.INTEGER
     * </ul>
     *
     ...
     */
    public void copy(VipstatusBean bean) {
    ...
    public String toString() {
        return   "\n[vipstatus] "
                 + "\n - vipstatus.vipstatusid = " + (vipstatusid_is_initialized ? ("[" + (vipstatusid == null ? null : vipstatusid.toString()) + "]") : "not initialized") + ""
                 + "\n - vipstatus.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
                 + "\n - vipstatus.active = " + (active_is_initialized ? ("[" + (active == null ? null : active.toString()) + "]") : "not initialized") + ""
            ;
    }
