...
/**
 * Handles database calls for the v_bcancelled table.
 */
public class VBcancelledManager
// extends+ 
...

{
    ...
    private static final String TABLE_NAME = "v_bcancelled";

    /**
     * Create an array of type string containing all the fields of the v_bcancelled table.
     */
    private static final String[] FIELD_NAMES = 
    {
        "v_bcancelled.reservationid"
        ,"v_bcancelled.guest"
        ,"v_bcancelled.arraivaldate"
        ,"v_bcancelled.departuredate"
        ,"v_bcancelled.num"
        ,"v_bcancelled.charges"
        ,"v_bcancelled.paid"
        ,"v_bcancelled.balance"
        ,"v_bcancelled.source"
        ,"v_bcancelled.puser"
        ,"v_bcancelled.regdate"
        ,"v_bcancelled.remark"
        ,"v_bcancelled.regbyid"
        ,"v_bcancelled.bsourceid"
        ,"v_bcancelled.roomtypeid"
        ,"v_bcancelled.ratetypeid"
    };

    /**
     * Field that contains the comma separated fields of the v_bcancelled table.
     */
    private static final String ALL_FIELDS = "v_bcancelled.reservationid"
                            + ",v_bcancelled.guest"
                            + ",v_bcancelled.arraivaldate"
                            + ",v_bcancelled.departuredate"
                            + ",v_bcancelled.num"
    ...
    private static VBcancelledManager singleton = new VBcancelledManager();

    /**
     * Get the VBcancelledManager singleton.
     *
     * @return VBcancelledManager 
     */
    synchronized public static VBcancelledManager getInstance()
    {
        return singleton;
    }

    /**
     * Sets your own VBcancelledManager instance.
     <br>
     * This is optional, by default we provide it for you.
     */
    synchronized public static void setInstance(VBcancelledManager instance)
    {
        singleton = instance;
    }
    ...
    /**
     * Creates a new VBcancelledBean instance.
     *
     * @return the new VBcancelledBean 
     */
    public VBcancelledBean createVBcancelledBean()
    {
        return new VBcancelledBean();
    }
    ...
    /**
     * Loads all the rows from v_bcancelled.
     *
     * @return an array of VBcancelledManager pObject
     */
    //38
    public VBcancelledBean[] loadAll() throws SQLException 
    {
        Connection c = null;
        ...
        {
            c = getConnection();
            ps = c.prepareStatement("SELECT " + ALL_FIELDS + " FROM v_bcancelled",ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
    ...
    //////////////////////////////////////
    /**
     * Retrieves an array of VBcancelledBean given a sql 'where' clause.
     *
     * @param where the sql 'where' clause
     * @return the resulting VBcancelledBean table 
     */
    //49
    public VBcancelledBean[] loadByWhere(String where) throws SQLException
    {
        return loadByWhere(where, null);
    }

    /**
     * Retrieves an array of VBcancelledBean given a sql where clause, and a list of fields.
     ...
     */
    //51
    public VBcancelledBean[] loadByWhere(String where, int[] fieldList) throws SQLException
    {
        String sql = null;
        if(fieldList == null)
            sql = "select " + ALL_FIELDS + " from v_bcancelled " + where;
        else
        {
        ...
        try 
        {
            ...
            return (VBcancelledBean[])v.toArray(new VBcancelledBean[0]);
        }
        finally
        {
            if (v != null) { v.clear(); }
    ...
    /**
     * Deletes all rows from v_bcancelled table.
    ...
    /**
     * Deletes rows from the v_bcancelled table using a 'where' clause.
     * It is up to you to pass the 'WHERE' in your where clausis.
    ...
    public int deleteByWhere(String where) throws SQLException
    {
        ...
        {
            c = getConnection();
            String delByWhereSQL = "DELETE FROM v_bcancelled " + where;
    ...
    ///////////////////////////////////////////////////////////////////////
    /**
     * Saves the VBcancelledBean pObject into the database.
     *
     * @param pObject the VBcancelledBean pObject to be saved
     */
    //100
    public VBcancelledBean save(VBcancelledBean pObject) throws SQLException
    {
        Connection c = null;
        PreparedStatement ps = null;
        ...
        try
        {
            ...
            { // SAVE 
                ...
                int _dirtyCount = 0;
                _sql = new StringBuffer("INSERT into v_bcancelled (");
            ...
            { // UPDATE 
                ...
                _sql = new StringBuffer("UPDATE v_bcancelled SET ");
    ...
    /**
     * Saves an array of VBcancelledBean pObjects into the database.
     *
     * @param pObjects the VBcancelledBean pObject table to be saved
     * @return the saved VBcancelledBean array.
     */
    //65
    public VBcancelledBean[] save(VBcancelledBean[] pObjects) throws SQLException 
    {
    ...
    ///////////////////////////////////////////////////////////////////////
    /**
     * Loads a unique VBcancelledBean pObject from a template one giving a c
     *
     * @param pObject the VBcancelledBean pObject to look for
     * @return the pObject matching the template
     */
    //85
    public VBcancelledBean loadUniqueUsingTemplate(VBcancelledBean pObject) throws SQLException
    {
         VBcancelledBean[] pReturn = loadUsingTemplate(pObject);
         if (pReturn.length == 0)
             return null;
         if (pReturn.length > 1)
    ...
    /**
     * Loads an array of VBcancelledBean from a template one.
     *
     * @param pObject the VBcancelledBean template to look for
     * @return all the VBcancelledBean matching the template
     */
    //88
    public VBcancelledBean[] loadUsingTemplate(VBcancelledBean pObject) throws SQLException
    {
        Connection c = null;
        PreparedStatement ps = null;
        StringBuffer where = new StringBuffer("");
        StringBuffer _sql = new StringBuffer("SELECT " + ALL_FIELDS + " from v_bcancelled WHERE ");
    ...
    /**
     * Deletes rows using a VBcancelledBean template.
     *
     * @param pObject the VBcancelledBean object(s) to be deleted
     * @return the number of deleted objects
     */
    //63
    public int deleteUsingTemplate(VBcancelledBean pObject) throws SQLException
    {
        Connection c = null;
        PreparedStatement ps = null;
        ...
        try 
        {
            sql = new StringBuffer("DELETE FROM v_bcancelled WHERE ");
            int _dirtyAnd = 0;
    ...
    /**
     * Retrieves the number of rows of the table v_bcancelled.
     *
    ...
    /**
     * Retrieves the number of rows of the table v_bcancelled with a 'where' clause.
     * It is up to you to pass the 'WHERE' in your where clausis.
     *
    ...
    {
        String sql = "select count(*) as MCOUNT from v_bcancelled " + where;
        Connection c = null;
        Statement pStatement = null;
        ResultSet rs =  null;
        try 
    ...
    /**
     * Retrieves the number of rows of the table v_bcancelled with a prepared statement.
     *
    ...
    /**
     * Looks for the number of elements of a specific VBcancelledBean pObject given a c
     *
     * @param pObject the VBcancelledBean pObject to look for
     * @return the number of rows returned
     */
    //83
    public int countUsingTemplate(VBcancelledBean pObject) throws SQLException
    {
        StringBuffer where = new StringBuffer("");
        Connection c = null;
        PreparedStatement ps = null;
        ...
        try
        {
                _sql = new StringBuffer("SELECT count(*) as MCOUNT  from v_bcancelled WHERE ");
    ...
    ///////////////////////////////////////////////////////////////////////
    /**
     * Transforms a ResultSet iterating on the v_bcancelled on a VBcancelledBean pObject.
     *
     * @param rs the ResultSet to be transformed
     * @return pObject resulting VBcancelledBean pObject
     */
    //72
    public VBcancelledBean decodeRow(ResultSet rs) throws SQLException
    {
        VBcancelledBean pObject = createVBcancelledBean();
    ...
    /**
     * Transforms a ResultSet iterating on the v_bcancelled table on a VBcancelledBean pObject according to a list of fields.
     *
     * @param rs the ResultSet to be transformed
     * @param fieldList table of the field's associated constants
     * @return pObject resulting VBcancelledBean pObject
     */
    //73
    public VBcancelledBean decodeRow(ResultSet rs, int[] fieldList) throws SQLException
    {
        VBcancelledBean pObject = createVBcancelledBean();
        int pos = 0;
        for(int i = 0; i < fieldList.length; i++)
     ...
     *
     * @param ps the PreparedStatement to be used
     * @return an array of VBcancelledBean 
     */
    //41
    public VBcancelledBean[] loadByPreparedStatement(PreparedStatement ps) throws SQLException
    {
     ...
     * @return an array of VBcancelledBean 
     */
    public VBcancelledBean[] loadByPreparedStatement(PreparedStatement ps, int[] fieldList) throws SQLException
    {
        ResultSet rs =  null;
        java.util.ArrayList v =  null;
        try
    ...
    // LISTENER 
    ///////////////////////////////////////////////////////////////////////
    private VBcancelledListener listener = null;

    /**
     * Registers a unique VBcancelledListener listener.
     */
    //66.5
    public void registerListener(VBcancelledListener listener) {
        this.listener = listener;
    }

    /**
     * Before the save of the VBcancelledBean pObject.
     *
     * @param pObject the VBcancelledBean pObject to be saved
     */
    //67
    void beforeInsert(VBcancelledBean pObject) throws SQLException {
        if (listener != null)
            listener.beforeInsert(pObject);
    }

    /**
     * After the save of the VBcancelledBean pObject.
     *
     * @param pObject the VBcancelledBean pObject to be saved
     */
    //68
    void afterInsert(VBcancelledBean pObject) throws SQLException {
        if (listener != null)
            listener.afterInsert(pObject);
    }

    /**
     * Before the update of the VBcancelledBean pObject.
     *
     * @param pObject the VBcancelledBean pObject to be updated
     */
    //69
    void beforeUpdate(VBcancelledBean pObject) throws SQLException {
        if (listener != null)
            listener.beforeUpdate(pObject);
    }

    /**
     * After the update of the VBcancelledBean pObject.
     *
     * @param pObject the VBcancelledBean pObject to be updated
     */
    //70
    void afterUpdate(VBcancelledBean pObject) throws SQLException {
        if (listener != null)
