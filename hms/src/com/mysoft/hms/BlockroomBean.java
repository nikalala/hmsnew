...

{
     ...
     * <ul>
     * <li>full name: blockroom.blockroomid
     * <li>column size: 19
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: blockroom.reasonid
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: blockroom.regdate
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: blockroom.regbyid
     ...
     */
    public void copy(BlockroomBean bean) {
    ...
    public String toString() {
        return   "\n[blockroom] "
                 + "\n - blockroom.blockroomid = " + (blockroomid_is_initialized ? ("[" + (blockroomid == null ? null : blockroomid.toString()) + "]") : "not initialized") + ""
                 + "\n - blockroom.roomid = " + (roomid_is_initialized ? ("[" + (roomid == null ? null : roomid.toString()) + "]") : "not initialized") + ""
                 + "\n - blockroom.blockstart = " + (blockstart_is_initialized ? ("[" + (blockstart == null ? null : blockstart.toString()) + "]") : "not initialized") + ""
                 + "\n - blockroom.blockend = " + (blockend_is_initialized ? ("[" + (blockend == null ? null : blockend.toString()) + "]") : "not initialized") + ""
                 + "\n - blockroom.reasonid = " + (reasonid_is_initialized ? ("[" + (reasonid == null ? null : reasonid.toString()) + "]") : "not initialized") + ""
