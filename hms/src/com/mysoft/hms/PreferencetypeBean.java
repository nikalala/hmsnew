...

{
     ...
     * <ul>
     * <li>full name: preferencetype.preferencetypeid
     * <li>column size: 10
     ...
     */
    public void copy(PreferencetypeBean bean) {
    ...
    public String toString() {
        return   "\n[preferencetype] "
                 + "\n - preferencetype.preferencetypeid = " + (preferencetypeid_is_initialized ? ("[" + (preferencetypeid == null ? null : preferencetypeid.toString()) + "]") : "not initialized") + ""
                 + "\n - preferencetype.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
                 + "\n - preferencetype.regbyid = " + (regbyid_is_initialized ? ("[" + (regbyid == null ? null : regbyid.toString()) + "]") : "not initialized") + ""
                 + "\n - preferencetype.regdate = " + (regdate_is_initialized ? ("[" + (regdate == null ? null : regdate.toString()) + "]") : "not initialized") + ""
                 + "\n - preferencetype.active = " + (active_is_initialized ? ("[" + (active == null ? null : active.toString()) + "]") : "not initialized") + ""
                 + "\n - preferencetype.deteted = " + (deteted_is_initialized ? ("[" + (deteted == null ? null : deteted.toString()) + "]") : "not initialized") + ""
            ;
    }
