...

{
     ...
     * <li>comments: 0 - Room owner, 1 - Company, 2 - Travel agent
     * <li>column size: 10
     ...
     * <li>comments: 0 - % on all nights, 1 - Fixed amount per night, 2 - Fidex amount per stay
     * <li>column size: 10
     * <li>jdbc type returned by the driver: Types.INTEGER
     * </ul>
     *
     ...
     * <li>comments: 0 - Regular, 1 - Special, 2 - Allocated
     * <li>column size: 10
     * <li>jdbc type returned by the driver: Types.INTEGER
     * </ul>
     *
     ...
     * <li>comments: 0 - Regular, 1 - Allocated
     * <li>column size: 10
     * <li>jdbc type returned by the driver: Types.INTEGER
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: contragent.active
    ...
    public String toString() {
        return   "\n[contragent] "
                 ...
                 + "\n - contragent.active = " + (active_is_initialized ? ("[" + (active == null ? null : active.toString()) + "]") : "not initialized") + ""
            ;
    }
