...

{
    ...
    /**
     * Retrieves an array of PayoutBean using the relation table Folioitem given a TaxBean object.
     *
     * @param pObject the TaxBean pObject to be used
     * @return an array of PayoutBean 
     */
    // MANY TO MANY
    public PayoutBean[] loadPayoutViaFolioitem(TaxBean pObject) throws SQLException
    {
         Connection c = null;
         PreparedStatement ps = null;
         String strSQL =      " SELECT "
    ...
    /**
     * Retrieves an array of ReservationroomBean using the relation table Folioitem given a TaxBean object.
     *
     * @param pObject the TaxBean pObject to be used
     * @return an array of ReservationroomBean 
     */
    // MANY TO MANY
    public ReservationroomBean[] loadReservationroomViaFolioitem(TaxBean pObject) throws SQLException
    {
         Connection c = null;
         PreparedStatement ps = null;
         String strSQL =      " SELECT "
