...

{
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: v_sharer_2.guestid
     * <li>column size: 19
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: v_sharer_2.reservationroomid
     * <li>column size: 19
     * <li>jdbc type returned by the driver: Types.BIGINT
     * </ul>
     *
     ...
     */
    public void copy(VSharer2Bean bean) {
    ...
    public String toString() {
        return   "\n[v_sharer_2] "
                 + "\n - v_sharer_2.guest = " + (guest_is_initialized ? ("[" + (guest == null ? null : guest.toString()) + "]") : "not initialized") + ""
                 + "\n - v_sharer_2.guestid = " + (guestid_is_initialized ? ("[" + (guestid == null ? null : guestid.toString()) + "]") : "not initialized") + ""
                 + "\n - v_sharer_2.reservationroomid = " + (reservationroomid_is_initialized ? ("[" + (reservationroomid == null ? null : reservationroomid.toString()) + "]") : "not initialized") + ""
            ;
    }
