...

{
    ...
    private boolean preferenceid_is_modified = false;
    private boolean preferenceid_is_initialized = false;
    ...
    private boolean preferencetypeid_is_initialized = false;
    ...
    /**
     * Getter method for preferenceid.
     * <br>
     * PRIMARY KEY.<br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: preference.preferenceid
     * <li>column size: 10
    ...
    /**
     * Setter method for preferenceid.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to preferenceid
     */
    public void setPreferenceid(Integer newVal) {
        if ((newVal != null && this.preferenceid != null && (newVal.compareTo(this.preferenceid) == 0)) || 
            (newVal == null && this.preferenceid == null && preferenceid_is_initialized)) {
            return; 
        } 
        this.preferenceid = newVal; 
        preferenceid_is_modified = true; 
        preferenceid_is_initialized = true; 
    }
     ...
     * @param newVal the new value to be assigned to preferenceid
     */
    public void setPreferenceid(int newVal) {
        setPreferenceid(new Integer(newVal));
    }

    /**
     * Determines if the preferenceid has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isPreferenceidModified() {
        return preferenceid_is_modified; 
    }

    /**
     * Determines if the preferenceid has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isPreferenceidInitialized() {
        return preferenceid_is_initialized; 
    }
    ...
    /**
     * Getter method for preferencetypeid.
     * <br>
     * Meta Data Information (in progress):
     * <ul>
     ...
     * </ul>
     *
     * @return the value of preferencetypeid
     */
    ...
    /**
     * Setter method for preferencetypeid.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to preferencetypeid
     */
    public void setPreferencetypeid(Integer newVal) {
     ...
     * @param newVal the new value to be assigned to preferencetypeid
     */
    public void setPreferencetypeid(int newVal) {
        setPreferencetypeid(new Integer(newVal));
    }

    /**
     * Determines if the preferencetypeid has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isPreferencetypeidModified() {
        return preferencetypeid_is_modified; 
    }

    /**
     * Determines if the preferencetypeid has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isPreferencetypeidInitialized() {
        return preferencetypeid_is_initialized; 
    }
    ...
    public void resetIsModified() {
        preferenceid_is_modified = false;
        name_is_modified = false;
        preferencetypeid_is_modified = false;
     ...
     */
    public void copy(PreferenceBean bean) {
        setPreferenceid(bean.getPreferenceid());
        setName(bean.getName());
        setPreferencetypeid(bean.getPreferencetypeid());
    ...
    public String toString() {
        return   "\n[preference] "
                 + "\n - preference.preferenceid = " + (preferenceid_is_initialized ? ("[" + (preferenceid == null ? null : preferenceid.toString()) + "]") : "not initialized") + ""
                 + "\n - preference.name = " + (name_is_initialized ? ("[" + (name == null ? null : name.toString()) + "]") : "not initialized") + ""
                 + "\n - preference.preferencetypeid = " + (preferencetypeid_is_initialized ? ("[" + (preferencetypeid == null ? null : preferencetypeid.toString()) + "]") : "not initialized") + ""
                 + "\n - preference.regbyid = " + (regbyid_is_initialized ? ("[" + (regbyid == null ? null : regbyid.toString()) + "]") : "not initialized") + ""
