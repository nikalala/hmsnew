...

{
    ...
    private Integer extrapostingtype;
    private boolean extrapostingtype_is_modified = false;
    private boolean extrapostingtype_is_initialized = false;
    ...
    /**
     * Getter method for extrapostingtype.
     * <br>
     * Meta Data Information (in progress):
     * <ul>
     ...
     * </ul>
     *
     * @return the value of extrapostingtype
     */
    public Integer getExtrapostingtype()
    {
        return extrapostingtype; 
    }

    /**
     * Setter method for extrapostingtype.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to extrapostingtype
     */
    public void setExtrapostingtype(Integer newVal) {
        if ((newVal != null && this.extrapostingtype != null && (newVal.compareTo(this.extrapostingtype) == 0)) || 
            (newVal == null && this.extrapostingtype == null && extrapostingtype_is_initialized)) {
            return; 
        } 
        this.extrapostingtype = newVal; 
        extrapostingtype_is_modified = true; 
        extrapostingtype_is_initialized = true; 
    }
     ...
     * @param newVal the new value to be assigned to extrapostingtype
     */
    public void setExtrapostingtype(int newVal) {
        setExtrapostingtype(new Integer(newVal));
    }

    /**
     * Determines if the extrapostingtype has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isExtrapostingtypeModified() {
        return extrapostingtype_is_modified; 
    }

    /**
     * Determines if the extrapostingtype has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isExtrapostingtypeInitialized() {
        return extrapostingtype_is_initialized; 
    }
    ...
    public void resetIsModified() {
        ...
        extrapostingtype_is_modified = false;
    ...
    public void copy(ExtrachargeBean bean) {
        ...
        setExtrapostingtype(bean.getExtrapostingtype());
    ...
    public String toString() {
        return   "\n[extracharge] "
                 ...
                 + "\n - extracharge.extrapostingtype = " + (extrapostingtype_is_initialized ? ("[" + (extrapostingtype == null ? null : extrapostingtype.toString()) + "]") : "not initialized") + ""
                 ...
                 + "\n - extracharge.deleted = " + (deleted_is_initialized ? ("[" + (deleted == null ? null : deleted.toString()) + "]") : "not initialized") + ""
            ;
    }
