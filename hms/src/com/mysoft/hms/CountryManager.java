...

{
     ...
     */
    public static final int ID_EXT = 5;
    ...
    /**
     * Loads CountryBean array from the country table using its changebyid field.
     *
     * @return an array of CountryBean 
     */
    // LOAD BY IMPORTED KEY
    public CountryBean[] loadByChangebyid(Integer value) throws SQLException 
    {
        Connection c = null;
        PreparedStatement ps = null;
        try 
        {
            c = getConnection();
            ps = c.prepareStatement("SELECT " + ALL_FIELDS + " FROM country WHERE changebyid=?",ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
    ...
    /**
     * Deletes from the country table by changebyid field.
     *
    ...
    public int deleteByChangebyid(Integer value) throws SQLException 
    {
        ...
        {
            c = getConnection();
            ps = c.prepareStatement("DELETE FROM country WHERE changebyid=?");
            Manager.setInteger(ps, 1, value);
            return ps.executeUpdate();
        }
        finally
    ...
    //////////////////////////////////////
    /**
     * Retrieves the PersonnelBean object from the country.personnelid field.
     *
     * @param pObject the CountryBean 
     * @return the associated PersonnelBean pObject
     */
    // GET IMPORTED
    public PersonnelBean getPersonnelBean(CountryBean pObject) throws SQLException
    {
    ...
    /**
     * Associates the CountryBean object to the PersonnelBean object.
     *
     * @param pObject the CountryBean object to use
     * @param pObjectToBeSet the PersonnelBean object to associate to the CountryBean 
     * @return the associated PersonnelBean pObject
     */
    // SET IMPORTED
    public CountryBean setPersonnelBean(CountryBean pObject,PersonnelBean pObjectToBeSet)
    {
