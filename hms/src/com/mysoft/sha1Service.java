...
public class sha1Service {
            ...
            public static String sha1(String password) throws Exception {
                String result = new sun.misc.BASE64Encoder().encode(MessageDigest.getInstance("SHA1").digest(password.getBytes()));
                return result;

            }
            
            public static String md5(String password) throws Exception {
                return asHex(MessageDigest.getInstance("MD5").digest(password.getBytes()));
            }
        }
