...
<%
    ...
    String[] workOrderCategory = {
            "დასუფთავება", "მოვლა", "სხვა დავალება", "შეკეთება"
    };
    String[] workOrderStatus = {
            "მინიჭებული", "შესრულებული", "პროცესში", "ახალი"
    };
    String[] workOrderPriority = {
            "მაღალი", "საშუალო", "დაბალი"
    };
    String[] amenitytype = {
            "ოთახი", "სასტუმრო", "ორივე"
    };
    String[] contragenttype = {
            "ოთახის მფლობელი", "კომპანია", "ტურისტული აგენტი", "მომწოდებელი", "სტუმარი", "web"
    };
    String[] commissionplan = {
            "% ყველა ღამეზე", "ფიქსირებული თანხა თითოეულ ღამეზე", "ფიქსირებული თანხა თითოეულ დარჩენაზე"
    };
    String[] rate = {
            "ჩვეულებრივი", "სპეციალური", "შეთანხმებული"
    };
    String[] roominventory = {
            "ჩვეულებრივი", "შეთანხმებული"
    };
    String[] documentnumbering = {
            "ავტომატური საერთო", "ავტომატური შიდა", "ხელით"
    };
    String[] chargeapplieson = {
            "თვითოეულ უფროსზე", "თვითოეულ ბავშვზე", "თვითოეულ ინსტანციაზე", "თვითოეულ პერსონაზე", "რაოდენობის მიხედვით"
    };
    String[] extrachargepostingtype = {
            "მიღება-გაწერის დროს", "ყოველდღე", "ყოველდღე გარდა მიღებისა", "ყოველდღე გარდა მიღება-გაწერისას", "ყოველდღე გარდა გაწერისა", "მხოლოდ მიღებისას", "მხოლოდ გაწერისას"
    };
    String[] foliostatus = {
            "რეზერვირებული", "გაუქმებული", "არ მოსვლა", "მიღებული", "წასული", "უარყოფილი"
    };
    String[] pax = {
            "უფროსი", "ბავშვი"
    };
    ...
    String[] paymentmethod0 = {
            "ნაღდი", "ბანკი"
    };
    String[] ratetype = {
            "ჩვეულებრივი", "სპეციალური", "ხელით"
    };
    String[] billto = {
            "კომპანია", "ჯგუფის ხელმძღვანელი", "სტუმარი", "ოთახი და გადასახადები კომპანიას, დანარჩენი სტუმარს"
    };
    String[] reservationpostingtype = {
            "ყოველი", "ყოველ ღამე", "მხოლოდ ბოლო ღამე"
    };
    String[] taxpostingtype = {
            "ფიქსირებული პროცენტი", "ფიქსირებული თანხა"
    };
    String[] discountplan = {
            "ყველა", "ყოველ ღამე", "მხოლოდ პირველი ღამე", "მხოლოდ ბოლო ღამე"
    };
    String[] hotelstar = {
            "უვარსკვლავო", "*", "**", "***", "****", "***** და მეტი"
    };
    String[] accounts = {
            "შემოსავალი გაუქმებიდან", "დღიური გამოყენების თანხა", "გვიან გაწერის თანხა", "ადრე მიღების თანხა", "არ გამოცხადების თანხა", "ოთახის ღირებულება"
    };
    String[] taxaccountnames = {
            "ოთახი", "გაუქმება", "არ გამოცხადება", "ადრე მიღება", "გვიან გაწერა", "დღიური გამოყენება", "ტურისტული აგენტის საკომისიო"
    };
    ...
    String[] dateformats = {
            "dd.MM.yyyy", "dd/MM/yyyy", "dd-MM-yyyy", "dd.MM.yy", "dd/MM/yy", "dd-MM-yy", "MM.dd.yyyy", "MM/dd/yyyy", "MM-dd-yyyy", "MM.dd.yy", "MM/dd/yy", "MM-dd-yy"
    };
    String[] dateformats1 = {
            "dd.mm.yyyy", "dd/mm/yyyy", "dd-mm-yyyy", "dd.mm.yy", "dd/mm/yy", "dd-mm-yy", "mm.dd.yyyy", "mm/dd/yyyy", "mm-dd-yyyy", "mm.dd.yy", "mm/dd/yy", "mm-dd-yy"
    };
    ...
    String[] arrdepdateformats = {
            "dd.MM", "dd/MM", "dd-MM", "MM.dd", "MM/dd", "MM-dd"
    };
    String[] yaermonthdateformats = {
            "yy.MM", "yy/MM", "yy-MM", "MM.yy", "MM/yy", "MM-yy"
    };
