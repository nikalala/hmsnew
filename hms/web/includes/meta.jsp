...
String[] contragenttype = {"ოთახის მფლობელი","კომპანია","ტურისტული აგენტი","მომწოდებელი","სტუმარი"};
String[] commissionplan = {"% ყველა ღამეზე", "ფიქსირებული თანხა თვითოეულ ღამეზე", "ფიქსირებული თანხა თვითოეულ დარჩენაზე"};
...
String[] roomstatus = {"დადასტურებული რეზერვაცია","მცხოვრები","ვადაგადაცილებული","წამსვლელი","გაწერილი","დაბლოკილი","დღიური გამოყენება"};
