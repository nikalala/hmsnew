...
<%
    ...
    String[] workOrderStatus = {"მაღალი", "საშუალო", "დაბალი"};
    String[] workOrderPriority = {"მინიჭებული", "შესრულებული", "პროცესში", "ახალი"};
    ...
    String[] reservationstatus = {"აქტიური", "გაუქმებული", "არ გამოცხადებული", "წაშლილი", "გაწერილი"};
