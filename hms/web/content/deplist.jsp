        ...
        <tr>
            <td>
                ...
                <div style="width: 100%; float:left;">
                    ...
                    <div class="col-md-4">
                        <input type="checkbox" id="todaydepguests" style="float: right;margin-left: 4px;"><label style="font-weight: normal;">დღეს გაწერილი სტუმრები:</label>
                    </div>
                    <div class="col-md-6">
                        <input type="checkbox" id="expressdep" style="float: right;margin-left: 4px;"><label style="font-weight: normal;">ექსპრეს გაწერა:</label>
                    </div>
                    <div class="col-md-2">
