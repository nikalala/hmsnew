...
<% RoomtypeBean[] roomtypes = RoomtypeManager.getInstance().loadAll(); %>
...
<script type="text/javascript">
  ...
  function doFilter(){
    loader.show();
    $.post("content/reports/content/Inventory-By-Room-Type.html",function(data){
  ...
  <table id="grid-table" style="margin: 10px;">
    <tr>
      <td style="width: 180px;">
        <label>Inventory By Room Type:</label>
      </td>
      <td>
