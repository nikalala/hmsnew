...
<script type="text/javascript">
    ...
    {
        jQuery("#list38").jqGrid(
            {
                url:'content/lm3/getlm38.jsp',
                datatype: "xml",
                colNames:['დასახელება'],
                colModel:[
                ...
                autowidth: false,
                rowList:[20,50,100],
                pager: jQuery('#pager38'),
                sortname: 'name',
                viewrecords: true,
                sortorder: "asc",
                editurl:"content/lm3/updlm38.jsp",
                caption:"შაბლონების კატეგორიები"
            })
            .navGrid('#pager38',{edit:true,add:true,del:true,view:false,search:false},
...
<table id="list38" width="100%" align="center"></table>
<div id="pager38"></div>
