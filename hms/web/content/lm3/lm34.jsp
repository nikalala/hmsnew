...
<script type="text/javascript">
    ...
    {
        jQuery("#list34").jqGrid(
            {
                url:'content/lm3/getlm34.jsp',
                datatype: "xml",
                colNames:['საბუთის ტიპი','სტატუსი'],
                colModel:[
                ...
                autowidth: false,
                rowList:[20,50,100],
                pager: jQuery('#pager34'),
                sortname: 'name',
                viewrecords: true,
                sortorder: "asc",
                editurl:"content/lm3/updlm34.jsp",
                caption:"საბუთის ტიპები"
            })
            .navGrid('#pager34',{edit:true,add:true,del:true,view:false,search:false},
...
<table id="list34" width="100%" align="center"></table>
<div id="pager34"></div>
