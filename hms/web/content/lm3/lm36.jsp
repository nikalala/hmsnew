...
<script type="text/javascript">
    ...
    {
        jQuery("#list36").jqGrid(
            {
                url:'content/lm3/getlm36.jsp',
                datatype: "xml",
                ...
                autowidth: false,
                rowList:[20,50,100],
                pager: jQuery('#pager36'),
                sortname: 'name',
                viewrecords: true,
                sortorder: "asc",
                editurl:"content/lm3/updlm36.jsp",
                caption:"გადასახადები"
            })
            .navGrid('#pager36',{edit:true,add:true,del:true,view:false,search:false},
...
<table id="list36" width="100%" align="center"></table>
<div id="pager36"></div>
