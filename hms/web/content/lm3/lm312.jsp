...
<script type="text/javascript">
    ...
    {
        jQuery("#list312").jqGrid(
            {
                url:'content/lm3/getlm312.jsp',
                datatype: "xml",
                colNames:['დასახელება','სტატუსი'],
                colModel:[
                ...
                autowidth: false,
                rowList:[20,50,100],
                pager: jQuery('#pager312'),
                sortname: 'name',
                viewrecords: true,
                sortorder: "asc",
                editurl:"content/lm3/updlm312.jsp",
                caption:"უპირატესობის ტიპები"
            })
            .navGrid('#pager312',{edit:true,add:true,del:true,view:false,search:false},
...
<table id="list312" width="100%" align="center"></table>
<div id="pager312"></div>
