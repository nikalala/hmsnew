...
<script type="text/javascript">
    ...
    {
        jQuery("#list310").jqGrid(
            {
                url:'content/lm3/getlm310.jsp',
                datatype: "xml",
                ...
                autowidth: false,
                rowList:[20,50,100],
                pager: jQuery('#pager310'),
                sortname: 'name',
                viewrecords: true,
                sortorder: "asc",
                editurl:"content/lm3/updlm310.jsp",
                caption:"ბაზრის კოდები"
            })
            .navGrid('#pager310',{edit:true,add:true,del:true,view:false,search:false},
...
<table id="list310" width="100%" align="center"></table>
<div id="pager310"></div>
