...
<%
String gridname = "departament";
String title = "განყოფილებები";
        ...
        jQuery("#<%=gridname%>").jqGrid(
            {
                ...
                colModel:[
                    ...
                    {align:'left', editable:true, editoptions:{size:4, maxlength:2}, editrules:{required: true}, edittype:'text', hidden:false, index:'code', name:'code', width:20},
                ],
                rowNum:20,
                height: 350,
                width:600,
