(function(a, b) {
    ...
    a.prototype = {
        ...
        updateSize: function() {
            if (this.isRealized()) {
                var e = this;
                this.getModal().removeClass(a.SIZE_NORMAL).removeClass(a.SIZE_SMALL).removeClass(a.SIZE_WIDE).removeClass(a.SIZE_LARGE).removeClass(a.SIZE_ELDAR);
                ...
                this.getModalDialog().removeClass("modal-eldar");
                if (this.getSize() === a.SIZE_ELDAR) {
                    this.getModalDialog().addClass("modal-eldar")
                }
