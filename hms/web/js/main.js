...
function sleep(milliseconds) {
      ...
      function savedata(id){
          ...
          if(maindiv === undefined || maindiv == ''){
              ...
              params = $('#'+maindiv+' [id]').map(function(){ return this.id; }).get();
              //params = ids.join(',');
          }
      ...
      function getBody(fname)
        ...
        function addTab(fname2,name,id){
            ...
            $.get(fname2, function(data) {$("#"+id).html(data);});
        ...
        function updateWalkinStayInfo(t){
            ...
            if(isNaN(nights) || nights == '') {nights = 1; $("#guestinfo_night").val(nights);}
            if(t == 1){
                ...
                $('#guestinfo_departuredate').on('changeDate', function(e){updateWalkinStayInfo(2);});
