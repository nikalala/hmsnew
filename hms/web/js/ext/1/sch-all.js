Ext.define("Sch.locale.Locale",
	{
	l10n:null,legacyMode:true,localeName:null,namespaceId:null,constructor:function()
		{
...
Ext.define("Sch.locale.En",
	{
	extend:"Sch.locale.Locale",singleton:true,l10n:
		{
		"Sch.util.Date":
			{
			unitNames:
		...
		,"Sch.plugin.EventEditor":
			{
			saveText:"Save",deleteText:"Delete",cancelText:"Cancel"
		}
...
Ext.define("Sch.util.Patch",
	{
	target:null,minVersion:null,maxVersion:null,reportUrl:null,description:null,applyFn:null,ieOnly:false,overrides:null,onClassExtended:function(a,b)
		{
...
Ext.define("Sch.patches.ColumnResize",
	{
	override:"Sch.panel.TimelineGridPanel",afterRender:function()
		{
...
Ext.define("Sch.patches.ElementScroll",
	{
	override:"Sch.mixin.TimelineView",_onAfterRender:function()
		{
		this.callParent(arguments);
...
Ext.define("Sch.mixin.Localizable",
	{
	requires:["Sch.locale.En"],legacyMode:true,activeLocaleId:"",l10n:null,isLocaleApplied:function()
		{
...
Ext.define("Sch.tooltip.ClockTemplate",
	...
	constructor:function()
		{
		var i=Math.PI/180,l=Math.cos,j=Math.sin,m=7,c=2,d=10,k=6,f=3,a=10,e=Ext.isIE&&(Ext.ieVersion<9||Ext.isIEQuirks);
		function b(n)
			{
		...
		return new Ext.XTemplate('<div class="sch-clockwrap {cls}"><div class="sch-clock"><div class="sch-hourIndicator" style="{[this.getHourStyle((values.date.getHours()%12) * 30)]}">{[Ext.Date.monthNames[values.date.getMonth()].substr(0,3)]}</div><div class="sch-minuteIndicator" style="{[this.getMinuteStyle(values.date.getMinutes() * 6)]}">{[values.date.getDate()]}</div></div><span class="sch-clock-text">{text}</span></div>',
			{
			compiled:true,disableFormats:true,getMinuteStyle:e?h:g,getHourStyle:e?b:g
		}
		)
	}
}
...
Ext.define("Sch.tooltip.Tooltip",
	{
	extend:"Ext.tip.ToolTip",requires:["Sch.tooltip.ClockTemplate"],autoHide:false,anchor:"b",padding:"0 3 0 0",showDelay:0,hideDelay:0,quickShowInterval:0,dismissDelay:0,trackMouse:false,valid:true,anchorOffset:5,shadow:false,frame:false,constructor:function(b)
		{
	...
	,update:function(a,e,d)
		...
		if(this.startDate-a!==0||this.endDate-e!==0||this.valid!==d)
			...
			this.callParent([this.template.apply(
				{
				valid:d,startDate:a,endDate:e,startText:c,endText:b
			}
			)])
		}
	}
...
Ext.define("Sch.util.Date",
	{
	requires:"Ext.Date",mixins:["Sch.mixin.Localizable"],singleton:true,stripEscapeRe:/(\\.)/g,hourInfoRe:/([gGhHisucUOPZ]|MS)/,unitHash:null,unitsByName:
		{
	}
	,constructor:function()
		{
		...
		var c=this.unitHash=
			{
			MILLI:a.MILLI,SECOND:a.SECOND,MINUTE:a.MINUTE,HOUR:a.HOUR,DAY:a.DAY,WEEK:"w",MONTH:a.MONTH,QUARTER:"q",YEAR:a.YEAR
		};
		Ext.apply(this,c);
		var b=this;
	...
	,add:function(b,c,e)
		...
		switch(c.toLowerCase())
			{
			case this.MILLI:f=new Date(b.getTime()+e);
			break;
			case this.SECOND:f=new Date(b.getTime()+(e*1000));
			break;
			case this.MINUTE:f=new Date(b.getTime()+(e*60000));
			break;
			case this.HOUR:f=new Date(b.getTime()+(e*3600000));
			break;
			case this.DAY:f.setDate(b.getDate()+e);
			break;
			case this.WEEK:f.setDate(b.getDate()+e*7);
			break;
			case this.MONTH:var a=b.getDate();
			if(a>28)
				{
			...
			break;
			case this.QUARTER:f=this.add(b,this.MONTH,e*3);
			break;
			case this.YEAR:f.setFullYear(b.getFullYear()+e);
			break
		}
		return f
	}
	...
	,getDurationInUnit:function(d,a,c)
		...
		switch(c)
			{
			case this.YEAR:b=Math.round(this.getDurationInYears(d,a));
			break;
			case this.QUARTER:b=Math.round(this.getDurationInMonths(d,a)/3);
			break;
			case this.MONTH:b=Math.round(this.getDurationInMonths(d,a));
			break;
			case this.WEEK:b=Math.round(this.getDurationInDays(d,a))/7;
			break;
			case this.DAY:b=Math.round(this.getDurationInDays(d,a));
			break;
			case this.HOUR:b=Math.round(this.getDurationInHours(d,a));
			break;
			case this.MINUTE:b=Math.round(this.getDurationInMinutes(d,a));
			break;
			case this.SECOND:b=Math.round(this.getDurationInSeconds(d,a));
			break;
			case this.MILLI:b=Math.round(this.getDurationInMilliseconds(d,a));
			break
		}
		return b
	}
	,getUnitToBaseUnitRatio:function(b,a)
		...
		switch(b)
			{
			case this.YEAR:switch(a)
				{
				case this.QUARTER:return 1/4;
				case this.MONTH:return 1/12
			}
			break;
			case this.QUARTER:switch(a)
				{
				case this.YEAR:return 4;
				case this.MONTH:return 1/3
			}
			break;
			case this.MONTH:switch(a)
				{
				case this.YEAR:return 12;
				case this.QUARTER:return 3
			}
			break;
			case this.WEEK:switch(a)
				{
				case this.DAY:return 1/7;
				case this.HOUR:return 1/168
			}
			break;
			case this.DAY:switch(a)
				{
				case this.WEEK:return 7;
				case this.HOUR:return 1/24;
				case this.MINUTE:return 1/1440
			}
			break;
			case this.HOUR:switch(a)
				{
				case this.DAY:return 24;
				case this.MINUTE:return 1/60
			}
			break;
			case this.MINUTE:switch(a)
				{
				case this.HOUR:return 60;
				case this.SECOND:return 1/60;
				case this.MILLI:return 1/60000
			}
			break;
			case this.SECOND:switch(a)
				{
				case this.MILLI:return 1/1000
			}
			break;
			case this.MILLI:switch(a)
				{
				case this.SECOND:return 1000
			}
			break
		}
		return-1
	...
	,getNext:function(c,g,a,f)
		...
		switch(g)
			{
			case this.MILLI:e=this.add(c,g,a);
			break;
			case this.SECOND:e=this.add(c,g,a);
			if(e.getMilliseconds()>0)
				{
				e.setMilliseconds(0)
			}
			break;
			case this.MINUTE:e=this.add(c,g,a);
			if(e.getSeconds()>0)
				{
				e.setSeconds(0)
			}
			...
			break;
			case this.HOUR:e=this.add(c,g,a);
			if(e.getMinutes()>0)
				{
				e.setMinutes(0)
			}
			...
			break;
			case this.DAY:var d=c.getHours()===23&&this.add(e,this.HOUR,1).getHours()===1;
			if(d)
				{
			...
			break;
			case this.WEEK:Ext.Date.clearTime(e);
			var b=e.getDay();
			...
			break;
			case this.MONTH:e=this.add(e,this.MONTH,a);
			e.setDate(1);
			Ext.Date.clearTime(e);
			break;
			case this.QUARTER:e=this.add(e,this.MONTH,((a-1)*3)+(3-(e.getMonth()%3)));
			Ext.Date.clearTime(e);
			e.setDate(1);
			break;
			case this.YEAR:e=new Date(e.getFullYear()+a,0,1);
			break;
			default:throw"Invalid date unit"
		}
		return e
	}
...
Ext.define("Sch.util.Debug",
	...
	singleton:true,runDiagnostics:function()
		...
		if(a&&a.log)
			...
			if(!window.schedulerDebugWin)
				...
				window.schedulerDebugWin=new Ext.Window(
					{
					height:400,width:500,bodyStyle:"padding:10px",closeAction:"hide",autoScroll:true
				}
				)
			}
		...
		var k=Ext.getCmp(e.elements[0].id),i=k.getResourceStore(),c=k.getEventStore();
		if(!c.isEventStore)
			{
...
Ext.define("Sch.util.DragTracker",
	{
	extend:"Ext.dd.DragTracker",xStep:1,yStep:1,setXStep:function(a)
		{
		this.xStep=a
	}
	,setYStep:function(a)
	...
	,onMouseDown:function(f,d)
		...
		Ext.getDoc().on(
			{
			scope:this,mouseup:this.onMouseUp,mousemove:this.onMouseMove,selectstart:this.stopSelect
		}
		);
		if(this.autoStart)
			{
...
Ext.define("Sch.preset.ViewPreset",
	{
	columnWidth:null,rowHeight:null,timeAxisColumnWidth:null,displayDateFormat:"G:i",shiftUnit:"HOUR",shiftIncrement:1,defaultSpan:12,timeResolution:null,headerConfig:null,headers:null,mainHeader:0,constructor:function(a)
		{
		Ext.apply(this,a)
	}
	,getHeaders:function()
	...
	,getTimeAxisConfig:function()
		{
		return {mainUnit:this.getMainHeader().unit,unit:this.getBottomHeader().unit,increment:this.getBottomHeader().increment,shiftUnit:this.shiftUnit,shiftIncrement:this.shiftIncrement,defaultSpan:this.defaultSpan,resolutionUnit:this.timeResolution.unit,resolutionIncrement:this.timeResolution.increment}
	}
	,clone:function()
		{
		var a=
		...
		var b=this;
		Ext.each(["columnWidth","rowHeight","timeAxisColumnWidth","dateFormat","shiftUnit","shiftIncrement","defaultSpan","timeResolution","headerConfig"],function(c)
			{
			a[c]=b[c]
		}
		);
...
Ext.define("Sch.preset.Manager",
	{
	extend:"Ext.util.MixedCollection",requires:["Sch.util.Date","Sch.preset.ViewPreset"],mixins:["Sch.mixin.Localizable"],singleton:true,constructor:function()
		{
		this.callParent(arguments);
	...
	,defaultPresets:
		...
		secondAndMinute:
			{
			timeColumnWidth:30,rowHeight:24,resourceColumnWidth:100,displayDateFormat:"G:i:s",shiftIncrement:10,shiftUnit:"MINUTE",defaultSpan:24,timeResolution:
				{
				unit:"SECOND",increment:5
			}
			,headerConfig:
				{
				middle:
					{
					unit:"SECOND",increment:10,align:"center",dateFormat:"s"
				}
				,top:
					{
					unit:"MINUTE",align:"center",dateFormat:"D, d g:iA"
				}
			}
		}
		,minuteAndHour:
			{
			timeColumnWidth:100,rowHeight:24,resourceColumnWidth:100,displayDateFormat:"G:i",shiftIncrement:1,shiftUnit:"HOUR",defaultSpan:24,timeResolution:
				{
			...
			,headerConfig:
				...
				middle:
					{
					unit:"MINUTE",increment:"30",align:"center",dateFormat:"i"
				}
				,top:
					{
					unit:"HOUR",align:"center",dateFormat:"D, gA/d"
				}
			}
		}
		,hourAndDay:
			{
			timeColumnWidth:60,rowHeight:24,resourceColumnWidth:100,displayDateFormat:"G:i",shiftIncrement:1,shiftUnit:"DAY",defaultSpan:24,timeResolution:
				{
				unit:"MINUTE",increment:30
			}
			,headerConfig:
				...
				middle:
					{
					unit:"HOUR",align:"center",dateFormat:"G:i"
				}
				,top:
					{
					unit:"DAY",align:"center",dateFormat:"D d/m"
				}
			}
		}
		,dayAndWeek:
			{
			timeColumnWidth:100,rowHeight:24,resourceColumnWidth:100,displayDateFormat:"Y-m-d G:i",shiftUnit:"DAY",shiftIncrement:1,defaultSpan:5,timeResolution:
				{
		...
		,weekAndDay:
			{
			timeColumnWidth:100,rowHeight:24,resourceColumnWidth:100,displayDateFormat:"Y-m-d",shiftUnit:"WEEK",shiftIncrement:1,defaultSpan:1,
                        timeResolution:{
			...
			,headerConfig:
				...
				bottom:
					{
					unit:"DAY",align:"center",increment:1,dateFormat:"d/m"
				}
				,middle:
					{
					unit:"WEEK",dateFormat:"D d M"
				}
			}
		}
		,weekAndMonth:
			{
			timeColumnWidth:100,rowHeight:24,resourceColumnWidth:100,displayDateFormat:"Y-m-d",shiftUnit:"WEEK",shiftIncrement:5,defaultSpan:6,timeResolution:
				{
				unit:"DAY",increment:1
			}
			,headerConfig:
				...
				,top:
					{
					unit:"MONTH",align:"center",dateFormat:"M Y"
				}
			}
		}
		,monthAndYear:
			{
			timeColumnWidth:110,rowHeight:24,resourceColumnWidth:100,displayDateFormat:"Y-m-d",shiftIncrement:3,shiftUnit:"MONTH",defaultSpan:12,timeResolution:
				{
				unit:"DAY",increment:1
			}
			,headerConfig:
				...
				,top:
					{
					unit:"YEAR",align:"center",dateFormat:"Y"
				}
			}
		}
		,year:
		...
		,manyYears:
			{
			timeColumnWidth:50,rowHeight:24,resourceColumnWidth:100,displayDateFormat:"Y-m-d",shiftUnit:"YEAR",shiftIncrement:1,defaultSpan:1,timeResolution:
				{
				unit:"YEAR",increment:1
			}
			,headerConfig:
				{
				middle:
		...
		,weekAndDayLetter:
			{
			timeColumnWidth:20,rowHeight:24,resourceColumnWidth:100,displayDateFormat:"Y-m-d",shiftUnit:"WEEK",shiftIncrement:1,defaultSpan:10,timeResolution:
				{
				unit:"DAY",increment:1
			}
			,headerConfig:
				...
				,middle:
					{
					unit:"WEEK",dateFormat:"D d M Y"
				}
			}
		}
		,weekDateAndMonth:
			{
			timeColumnWidth:30,rowHeight:24,resourceColumnWidth:100,displayDateFormat:"Y-m-d",shiftUnit:"WEEK",shiftIncrement:1,defaultSpan:10,timeResolution:
				{
				unit:"DAY",increment:1
			}
			,headerConfig:
				...
				middle:
					{
					unit:"WEEK",align:"center",dateFormat:"d"
				}
				,top:
					{
					unit:"MONTH",dateFormat:"Y F"
				}
			}
		}
	}
...
Ext.define("Sch.feature.AbstractTimeSpan",
	{
	extend:"Ext.AbstractPlugin",lockableScope:"top",schedulerView:null,timeAxis:null,containerEl:null,expandToFitView:false,disabled:false,cls:null,clsField:"Cls",template:null,store:null,renderElementsBuffered:false,renderDelay:15,refreshSizeOnItemUpdate:true,_resizeTimer:null,_renderTimer:null,showHeaderElements:false,headerTemplate:null,innerHeaderTpl:null,headerContainerCls:"sch-header-secondary-canvas",headerContainerEl:null,constructor:function(a)
		{
	...
	,init:function(a)
		...
		if(!this.schedulerView.getEl())
			...
			this.schedulerView.on(
				{
				afterrender:this.onAfterRender,scope:this
			}
			)
		}
		else
		...
		this.schedulerView.on(
			{
			destroy:this.onDestroy,scope:this
		}
		)
	}
	,onAfterRender:function(c)
		...
		this.storeListeners=
			{
			load:this.renderElements,datachanged:this.renderElements,clear:this.renderElements,add:this.refreshSingle,remove:this.renderElements,update:this.refreshSingle,addrecords:this.refreshSingle,removerecords:this.renderElements,updaterecord:this.refreshSingle,scope:this
		};
		...
		if(Ext.data.NodeStore&&a.store instanceof Ext.data.NodeStore)
			...
			if(a.animate)
				...
				a.mon(a.store,
					{
					expand:this.renderElements,collapse:this.renderElements,scope:this
				}
				)
			}
		}
		...
		if(a.headerCt)
			...
			a.headerCt.on(
				{
				add:this.renderElements,remove:this.renderElements,scope:this
			}
			)
		}
		this.panel.on(
			{
			viewchange:this.renderElements,show:this.refreshSizes,orientationchange:this.forceNewRenderingTimeout,scope:this
		}
		);
...
Ext.define("Sch.feature.DragCreator",
	{
	requires:["Ext.XTemplate","Sch.util.Date","Sch.util.DragTracker","Sch.tooltip.Tooltip","Sch.tooltip.ClockTemplate"],disabled:false,showHoverTip:true,showDragTip:true,dragTolerance:2,validatorFn:Ext.emptyFn,validatorFnScope:null,hoverTipTemplate:null,constructor:function(a)
		{
		Ext.apply(this,a||
			{
		}
	...
	,onDragStart:function()
		...
		if(b.getOrientation()==="horizontal")
			...
			d.rowBoundaries=
				{
				top:d.resourceRegion.top,bottom:d.resourceRegion.bottom
			};
			c.setRegion(
				{
				top:d.rowBoundaries.top,right:d.tracker.startXY[0],bottom:d.rowBoundaries.bottom,left:d.tracker.startXY[0]
			}
			)
		}
		else
			...
			d.rowBoundaries=
				{
				left:d.resourceRegion.left,right:d.resourceRegion.right
			};
			c.setRegion(
				{
				top:d.tracker.startXY[1],right:d.resourceRegion.right,bottom:d.tracker.startXY[1],left:d.resourceRegion.left
			}
			)
		}
		c.show();
	...
	,onDrag:function(f,h)
		{
		var d=this,c=d.schedulerView,b=d.tracker.getRegion().constrainTo(d.resourceRegion),g=c.getStartEndDatesFromRegion(b,"round");
		if(!g)
			{
			return
		}
	...
	,onDragEnd:function(d,f)
		{
		var c=this,a=c.schedulerView,b=true;
		c.dragging=false;
		if(c.showDragTip)
			{
			c.dragTip.disable()
		...
		c.createContext=
			{
			start:c.start,end:c.end,resourceRecord:c.resourceRecord,e:f,finalize:function()
				{
	...
	,tipCfg:
		{
		trackMouse:true,bodyCssClass:"sch-hovertip",autoHide:false,dismissDelay:1000,showDelay:300
	}
	,dragging:false,setupTooltips:function()
		{
		var b=this,a=b.schedulerView;
		b.tracker=new Sch.util.DragTracker(
			{
			el:a.el,tolerance:b.dragTolerance,listeners:
				{
				mousedown:b.verifyLeftButtonPressed,beforedragstart:b.onBeforeDragStart,dragstart:b.onDragStart,drag:b.onDrag,dragend:b.onDragEnd,scope:b
			}
		}
		);
		if(this.showDragTip)
			...
			this.dragTip=Ext.create("Sch.tooltip.Tooltip",
				{
				cls:"sch-dragcreate-tip",schedulerView:a,listeners:
					{
					beforeshow:function()
						{
						return b.dragging
		...
		if(b.showHoverTip)
			...
			b.hoverTip=new Ext.ToolTip(Ext.applyIf(
				{
				renderTo:document.body,target:c,disabled:b.disabled
			}
			,b.tipCfg));
			...
			a.mon(c,
				...
				,mousemove:b.onMouseMove,scope:b
			}
			)
		}
	}
...
Ext.define("Sch.feature.SchedulerDragZone",
	{
	extend:"Ext.dd.DragZone",requires:["Sch.tooltip.Tooltip","Ext.util.Point"],repairHighlight:false,repairHighlightColor:"transparent",containerScroll:false,dropAllowed:"sch-dragproxy",dropNotAllowed:"sch-dragproxy",showTooltip:true,tip:null,schedulerView:null,enableCopy:false,enableCopyKey:"SHIFT",validatorFn:function(b,a,c,f,d)
		{
		return true
	}
	,validatorFnScope:null,copyKeyPressed:false,constructor:function(c,a)
		...
		var b=this.proxy=this.proxy||Ext.create("Ext.dd.StatusProxy",
			{
			shadow:false,dropAllowed:this.dropAllowed,dropNotAllowed:this.dropNotAllowed,ensureAttachedToBody:Ext.emptyFn
		}
		);
		this.callParent(arguments);
		this.isTarget=true;
	...
	,setupConstraints:function(j,c,f,d,h,e)
		{
		this.clearTicks();
		var a=h&&e>1?e:0;
		var g=!h&&e>1?e:0;
		this.resetConstraints();
		this.initPageX=j.left+f;
		this.initPageY=j.top+d;
		var b=c.right-c.left;
		var i=c.bottom-c.top;
		if(h)
			{
			this.setXConstraint(j.left,j.right,a);
			this.setYConstraint(j.top+d,j.bottom-i+d,g)
		}
		else
			{
			this.setXConstraint(j.left+f,j.right-b+f,a);
			this.setYConstraint(j.top,j.bottom,g)
		}
	}
	...
	,getDragData:function(k)
		{
		var r=this.schedulerView,p=k.getTarget(r.eventSelector);
		if(!p)
			{
			return
		}
		var l=r.resolveEventRecord(p);
		if(!l||l.isDraggable()===false||r.fireEvent("beforeeventdrag",r,l,k)===false)
			{
			return null
		}
		var q=k.getXY(),a=Ext.get(p),d=a.getXY(),c=[q[0]-d[0],q[1]-d[1]],o=a.getRegion();
		a.removeCls("sch-event-hover");
		var m=r.getOrientation()=="horizontal";
		var b=r.resolveResource(p);
		if(r.constrainDragToResource&&!b)
			{
			throw"Resource could not be resolved for event: "+l.getId()
		}
		this.setupConstraints(r.getScheduleRegion(r.constrainDragToResource?b:null,l),o,c[0],c[1],m,r.getSnapPixelAmount());
		var n=l.getStartDate(),j=l.getEndDate(),h=r.timeAxis,g=this.getRelatedRecords(l),i=[a];
		Ext.Array.each(g,function(s)
			{
			var e=r.getElementFromEventRecord(s);
			if(e)
				{
				i.push(e)
			}
		...
		var f=
			{
			offsets:c,repairXY:d,eventEls:i,eventRecords:[l].concat(g),relatedEventRecords:g,resourceRecord:b,sourceDate:r.getDateFromCoordinate(q[m?0:1]),origStart:n,origEnd:j,startDate:n,endDate:j,timeDiff:0,startsOutsideView:n<h.getStart(),endsOutsideView:j>h.getEnd(),duration:j-n,bodyScroll:Ext.getBody().getScroll(),eventObj:k
		};
		...
		if(this.showTooltip)
			...
			if(!this.tip)
				...
				this.tip=Ext.create("Sch.tooltip.Tooltip",
					{
					schedulerView:a,cls:"sch-dragdrop-tip",renderTo:document.body
				}
				)
			}
	...
	,updateRecords:function(b)
		{
		var f=this,n=f.schedulerView,j=n.resourceStore,c=b.newResource,k=b.eventRecords[0],l=[],h=this.getCopyKeyPressed(),i=k.store;
		if(h)
			{
			k=k.copy();
			l.push(k)
		}
		var e=b.resourceRecord;
		k.beginEdit();
		if(c!==e)
			{
			k.unassign(e);
		...
		k.setStartDate(b.startDate,true,n.eventStore.skipWeekendsDuringDragDrop);
		k.endEdit();
		var a=b.timeDiff,m=Ext.data.TreeStore&&j instanceof Ext.data.TreeStore;
		var g=m?n.store:j;
		var d=g.indexOf(e)-g.indexOf(c);
		...
		n.fireEvent("eventdrop",n,b.eventRecords,h)
	}
	...
	,updateDragContext:function(f)
		...
		var d=this.schedulerView,g=a.refElement.getRegion();
		if(d.timeAxis.isContinuous())
			{
			var b=d.getDateFromCoordinate(f.getXY()[d.getOrientation()=="horizontal"?0:1]);
			a.timeDiff=b-a.sourceDate;
			a.startDate=d.timeAxis.roundDate(new Date(a.origStart-0+a.timeDiff));
			a.endDate=new Date(a.startDate-0+a.duration)
		}
		else
			{
			var c=this.resolveStartEndDates(g);
			a.startDate=c.startDate;
			a.endDate=c.endDate;
			a.timeDiff=a.startDate-a.origStart
		}
		a.newResource=d.constrainDragToResource?a.resourceRecord:this.resolveResource([g.left+a.offsets[0],g.top+a.offsets[1]],f);
		if(a.newResource)
			{
			a.valid=this.validatorFn.call(this.validatorFnScope||this,a.eventRecords,a.newResource,a.startDate,a.duration,f)
		}
		else
			{
			a.valid=false
...
Ext.define("Sch.feature.DragDrop",
	{
	requires:["Ext.XTemplate","Sch.feature.SchedulerDragZone"],validatorFn:function(b,a,c,f,d)
		{
		return true
	}
	...
	,initProxyLessDD:function()
		...
		a.eventDragZone=new Sch.feature.SchedulerDragZone(a.ownerCt.el,Ext.apply(
			{
			ddGroup:a.id,schedulerView:a,validatorFn:this.validatorFn,validatorFnScope:this.validatorFnScope
		}
		,this.dragConfig))
	}
}
...
Ext.define("Sch.feature.ResizeZone",
	{
	extend:"Ext.util.Observable",requires:["Ext.resizer.Resizer","Sch.tooltip.Tooltip"],showTooltip:true,validatorFn:Ext.emptyFn,validatorFnScope:null,schedulerView:null,origEl:null,handlePos:null,eventRec:null,tip:null,constructor:function(a)
		{
		Ext.apply(this,a);
		var b=this.schedulerView;
		b.on(
			{
			destroy:this.cleanUp,scope:this
		}
		);
		b.mon(b.el,
			{
			mousedown:this.onMouseDown,mouseup:this.onMouseUp,scope:this,delegate:".sch-resizable-handle"
		}
		);
		this.callParent(arguments)
	}
	,onMouseDown:function(f,a)
		...
		b.el.on(
			{
			mousemove:this.onMouseMove,scope:this,single:true
		}
		)
	}
	...
	,onMouseMove:function(f,a)
		...
		if(this.showTooltip)
			...
			if(!this.tip)
				...
				this.tip=Ext.create("Sch.tooltip.Tooltip",
					{
					schedulerView:b,cls:"sch-resize-tip"
				}
				)
			}
	...
	,createResizer:function(d,i,c)
		{
		var p=this.schedulerView,h=p.resolveResource(d),k=p.getSnapPixelAmount(),n=p.getScheduleRegion(h,i),b=p.getDateConstraints(h,i),m=d.getHeight,a=(p.rtl&&c[0]==="e")||(!p.rtl&&c[0]==="w")||c[0]==="n",g=
			{
			target:d,isStart:a,dateConstraints:b,resourceRecord:h,eventRecord:i,handles:c[0],minHeight:m,constrainTo:n,listeners:
				{
				resizedrag:this.partialResize,resize:this.afterResize,scope:this
			}
		};
		var o=d.id;
		var f="_"+o;
		d.id=d.dom.id=f;
		Ext.cache[f]=Ext.cache[o];
		if(p.getOrientation()==="vertical")
			...
			if(k>0)
				...
				Ext.apply(g,
					{
					minHeight:k,minWidth:j,maxWidth:j,heightIncrement:k
				}
				)
			}
		}
			...
			if(k>0)
				...
				Ext.apply(g,
					{
					minWidth:k,maxHeight:m,widthIncrement:k
				}
				)
			}
		}
		var l=Ext.create("Ext.resizer.Resizer",g);
		if(l.resizeTracker&&Ext.isWebKit)
			{
			var e=l.resizeTracker.updateDimensions;
			l.resizeTracker.updateDimensions=function(q)
				{
				if(q.getTarget(".sch-timelineview"))
					{
	...
	,afterResize:function(a,m,f,g)
		...
		j.resizeContext=
			{
			eventRecord:k,start:b,end:c,finalize:function()
				{
	...
	,finalize:function(a)
		...
		if(a)
			...
			if(this.resizer.isStart)
				{
				c.eventRecord.setStartDate(c.start,b.eventStore.skipWeekendsDuringDragDrop)
			}
			else
				{
				c.eventRecord.setEndDate(c.end,b.eventStore.skipWeekendsDuringDragDrop)
			}
		}
		else
			{
			b.repaintEventsForResource(c.eventRecord.getResource())
		}
...
Ext.define("Sch.eventlayout.Horizontal",
	{
	view:null,nbrOfBandsByResource:null,constructor:function(a)
		{
		Ext.apply(this,a);
	...
	,layoutEventsInBands:function(e,b)
		...
		do
			{
			var d=b[0],c=e===0?a.barMargin:(e*a.rowHeight-(e-1)*a.barMargin);
...
Ext.define("Sch.eventlayout.Vertical",
	{
	requires:["Sch.util.Date"],constructor:function(a)
		{
		Ext.apply(this,a)
	}
	...
	,getPriorOverlappingEvents:function(e,f)
		...
		for(var d=0,a=Ext.Array.indexOf(e,f);
		d<a;
		d++)
			{
...
Ext.define("Sch.column.Resource",
	{
	extend:"Ext.grid.Column",alias:"widget.resourcecolumn",cls:"sch-resourcecolumn-header",align:"center",menuDisabled:true,hideable:false,sortable:false,locked:false,lockable:false,draggable:false,enableLocking:false,tdCls:"sch-timetd",model:null
}
);
Ext.define("Sch.view.model.TimeAxis",
	{
	extend:"Ext.util.Observable",requires:["Ext.Date","Sch.util.Date"],timeAxis:null,availableWidth:0,tickWidth:100,snapToIncrement:false,forceFit:false,suppressFit:false,refCount:0,columnConfig:
		{
	}
	...
	,onTimeAxisReconfigure:function(b,a)
		...
		if(a)
			{
			this.setTickWidth(b.preset.timeColumnWidth)
		}
		else
			{
			this.update()
	...
	,update:function(d,b)
		{
		var e=this.timeAxis,c=e.headerConfig;
	...
	,createHeaderRow:function(a,d)
		{
		var c=[],e=this,g,f=d.align,b=Ext.Date.clearTime(new Date());
		e.timeAxis.forEachInterval(a,function(k,h,j)
			{
			g=
				{
				align:f,start:k,end:h,headerCls:""
			};
			if(d.renderer)
				{
	...
	,getDistanceBetweenDates:function(f,b)
		{
		var d=this.timeAxis.unit,c,e=Sch.util.Date.getMeasuringUnit(d),a=Sch.util.Date.getDurationInUnit(f,b,e);
	...
	,getDateFromPosition:function(a,d)
		{
		var c=a/this.getTickWidth(),b=this.timeAxis.getCount();
		if(c<0||c>b)
			{
			return null
		}
	...
	,calculateTickWidth:function(c)
		{
		var i=this.forceFit;
		var b=0,e=this.timeAxis.getUnit(),k=this.timeAxis.getCount(),h=Number.MAX_VALUE,f,a;
		if(this.snapToIncrement)
			{
			var g=this.timeAxis.getResolution(),j=g.unit,d=g.increment;
...
Ext.define("Sch.view.HorizontalTimeAxis",
	{
	extend:"Ext.util.Observable",requires:["Ext.XTemplate"],trackHeaderOver:true,compactCellWidthThreshold:15,baseCls:"sch-column-header",tableCls:"sch-header-row",headerHtmlRowTpl:'<table border="0" cellspacing="0" cellpadding="0" style="width: {totalWidth}px;{tstyle}" class="{{tableCls}}sch-header-row-{position}{cls}"><thead><tr><tpl for="cells"><td class="{{baseCls}}{headerCls}" style="position : static;text-align: {align};width: {width}px;{style}" tabIndex="0"headerPosition="{parent.position}" headerIndex="{[xindex-1]}"><div class="sch-simple-timeheader">{header}</div></td></tpl></tr></thead></table>',
        model:null,
        hoverCls:"",
        containerEl:null,
        height:null,
		...
		e.model.on(
			{
			update:e.onModelUpdate,scope:e
		}
		);
		...
		if(e.trackHeaderOver&&e.hoverCls)
			...
			e.containerEl.on(
				{
				mousemove:e.highlightCell,delegate:".sch-column-header",scope:e
			}
			);
			e.containerEl.on(
				{
				mouseleave:e.clearHighlight,scope:e
			}
			)
		}
		var c=
			{
			scope:this,delegate:".sch-column-header"
		};
		if(b)
			{
	...
	,destroy:function()
		...
		if(a.containerEl)
			...
			a.containerEl.un(
				{
				mousemove:a.highlightCell,delegate:".sch-simple-timeheader",scope:a
			}
			);
			a.containerEl.un(
				{
				mouseleave:a.clearHighlight,scope:a
			}
			)
		}
		a.model.un(
			{
			update:a.onModelUpdate,scope:a
		}
		)
	}
	...
	,getHTML:function(e,h,d)
		...
		if(i.top)
			...
			f+=this.headerHtmlRowTpl.apply(
				{
				totalWidth:g,cells:i.top,position:"top",tstyle:"border-top : 0;"+(b?"height:"+b+"px":"")
			}
			)
		}
		if(i.middle)
			...
			f+=this.headerHtmlRowTpl.apply(
				{
				totalWidth:g,cells:i.middle,position:"middle",tstyle:(i.top?"":"border-top : 0;")+(b?"height:"+b+"px":""),cls:!i.bottom&&this.model.getTickWidth()<=this.compactCellWidthThreshold?"sch-header-row-compact":""
			}
			)
		}
		if(i.bottom)
			...
			f+=this.headerHtmlRowTpl.apply(
				{
				totalWidth:g,cells:i.bottom,position:"bottom",tstyle:(b?"height:"+b+"px":""),cls:this.model.getTickWidth()<=this.compactCellWidthThreshold?"sch-header-row-compact":""
			}
			)
		}
...
Ext.define("Sch.column.timeAxis.Horizontal",
	{
	extend:"Ext.grid.column.Column",alias:"widget.timeaxiscolumn",draggable:false,groupable:false,hideable:false,sortable:false,fixed:true,menuDisabled:true,cls:"sch-simple-timeaxis",tdCls:"sch-timetd",enableLocking:false,requires:["Sch.view.HorizontalTimeAxis"],timeAxisViewModel:null,headerView:null,hoverCls:"sch-column-header-over",trackHeaderOver:true,compactCellWidthThreshold:20,initComponent:function()
		{
	...
	,afterRender:function()
		...
		a.headerView=new Sch.view.HorizontalTimeAxis(
			{
			model:a.timeAxisViewModel,containerEl:a.titleEl,hoverCls:a.ownHoverCls,trackHeaderOver:a.trackHeaderOver,compactCellWidthThreshold:a.compactCellWidthThreshold
		}
		);
...
Ext.define("Sch.column.timeAxis.Vertical",
	...
	,renderer:function(e,c,a,f)
		{
		var b=this.timeAxis.headerConfig,d=b.bottom||b.middle;
...
Ext.define("Sch.mixin.Lockable",
	{
	extend:"Ext.grid.locking.Lockable",useSpacer:true,syncRowHeight:false,horizontalScrollForced:false,injectLockable:function()
		{
		var j=this;
		...
		Ext.applyIf(j.lockedGridConfig,
			{
			useArrows:true,trackMouseOver:false,split:true,animCollapse:false,collapseDirection:"left",region:"west"
		}
		);
		Ext.applyIf(j.normalGridConfig,
			{
			viewType:j.viewType,layout:"fit",sortableColumns:false,enableColumnMove:false,enableColumnResize:false,enableColumnHide:false,getSchedulingView:function()
				{
...
if(!Ext.ClassManager.get("Sch.model.Customizable"))
	...
	Ext.define("Sch.model.Customizable",
		{
		extend:"Ext.data.Model",idProperty:null,customizableFields:null,previous:null,onClassExtended:function(b,d,a)
			{
				...
				Ext.Object.each(i,function(l,o)
					...
					if(e.containsKey(s))
						...
						g.push(new Ext.data.Field(Ext.applyIf(
							{
							name:p,isCustomizableField:true
						}
						,e.getByKey(s))))
					}
					else
						...
						e.add(new Ext.data.Field(Ext.applyIf(
							{
							name:s,isCustomizableField:true
						}
						,o)))
					}
...
Ext.define("Sch.model.Range",
	{
	extend:"Sch.model.Customizable",requires:["Sch.util.Date"],idProperty:"Id",config:
		{
		idProperty:"Id"
	}
	,startDateField:"StartDate",endDateField:"EndDate",nameField:"Name",clsField:"Cls",customizableFields:[
		{
	...
	,getDates:function()
		...
		for(var a=Ext.Date.clearTime(this.getStartDate(),true);
		a<b;
...
Ext.define("Sch.model.TimeAxisTick",
	{
	extend:"Sch.model.Range",startDateField:"start",endDateField:"end"
}
);
Ext.define("Sch.model.Event",
	{
	extend:"Sch.model.Range",idProperty:"Id",config:
		{
		idProperty:"Id"
	}
	,customizableFields:[
	...
	],resourceIdField:"ResourceId",draggableField:"Draggable",resizableField:"Resizable",getResource:function(b)
		{
...
if(!Ext.ClassManager.get("Sch.model.Resource"))
	...
	Ext.define("Sch.model.Resource",
		{
		extend:"Sch.model.Customizable",idProperty:"Id",config:
			{
			idProperty:"Id"
		}
		,nameField:"Name",customizableFields:["Id",
			{
			name:"Name",type:"string"
		}
...
Ext.define("Sch.data.mixin.EventStore",
	{
	model:"Sch.model.Event",config:
		{
		model:"Sch.model.Event"
	}
	,requires:["Sch.util.Date"],isEventStore:true,setResourceStore:function(a)
		{
		if(this.resourceStore)
			{
			this.resourceStore.un(
				{
				beforesync:this.onResourceStoreBeforeSync,write:this.onResourceStoreWrite,scope:this
			}
			)
		}
...
Ext.define("Sch.data.EventStore",
	{
	extend:"Ext.data.Store",model:"Sch.model.Event",config:
		{
		model:"Sch.model.Event"
	}
	,mixins:["Sch.data.mixin.EventStore"],constructor:function()
		{
		this.callParent(arguments);
		var a=function()
			{
		};
		a.prototype=Ext.ModelManager.getModel(this.getModel()).prototype;
		if(!(new a()instanceof Sch.model.Event))
			{
...
Ext.define("Sch.data.FilterableNodeStore",
	{
	extend:"Ext.data.NodeStore",onNodeExpand:function(f,d,c)
		{
		var b=[];
		for(var e=0;
		e<d.length;
	...
	,onNodeCollapse:function(e,c,b,g,d)
		{
		var f=this.data;
		var a=f.contains;
		f.contains=function()
...
Ext.define("Sch.data.mixin.FilterableTreeStore",
	{
	requires:["Sch.data.FilterableNodeStore"],nodeStoreClassName:"Sch.data.FilterableNodeStore",nodeStore:null,isFilteredFlag:false,lastTreeFilter:null,initTreeFiltering:function()
		{
		if(!this.nodeStore)
			{
	...
	,createNodeStore:function(a)
		...
		return Ext.create(this.nodeStoreClassName,
			{
			treeStore:a,recursive:true,rootVisible:this.rootVisible
		}
		)
	}
...
Ext.define("Sch.data.ResourceStore",
	{
	extend:"Ext.data.Store",model:"Sch.model.Resource",config:
		{
		model:"Sch.model.Resource"
	}
	,mixins:["Sch.data.mixin.ResourceStore"],constructor:function()
		{
		this.callParent(arguments);
		var a=function()
			{
		...
		a.prototype=Ext.ModelManager.getModel(this.getModel()).prototype;
		if(!(new a()instanceof Sch.model.Resource))
			{
...
Ext.define("Sch.data.ResourceTreeStore",
	{
	extend:"Ext.data.TreeStore",model:"Sch.model.Resource",mixins:["Sch.data.mixin.ResourceStore","Sch.data.mixin.FilterableTreeStore"],constructor:function()
		{
		this.callParent(arguments);
...
Ext.define("Sch.data.TimeAxis",
	{
	extend:"Ext.data.JsonStore",requires:["Sch.util.Date","Sch.model.TimeAxisTick"],model:"Sch.model.TimeAxisTick",continuous:true,autoAdjust:true,preset:null,unit:null,increment:null,resolutionUnit:null,resolutionIncrement:null,weekStartDay:null,mainUnit:null,shiftUnit:null,headerConfig:null,shiftIncrement:1,defaultSpan:1,constructor:function(a)
		{
		var b=this;
		if(b.setModel)
			{
		...
		b.on(Ext.versions.touch?"refresh":"datachanged",function(c,d)
			{
			b.fireEvent("reconfigure",b,d)
		}
		);
		if(a&&b.start)
			{
	...
	,reconfigure:function(c)
		{
		Ext.apply(this,c);
		var d=this.generateTicks(this.start,this.end,this.unit,this.increment||1,this.mainUnit);
		if(this.fireEvent("beforereconfigure",this,this.start,this.end)!==false)
			{
			var a=Ext.Object.getKeys(c).length;
			var b=(a===1&&"start"in c)||(a===2&&"start"in c&&"end"in c);
			this.removeAll(true);
			this.suspendEvents();
			this.add(d);
			if(this.getCount()===0)
			...
			this.resumeEvents();
			this.fireEvent("datachanged",this,!b);
			this.fireEvent("refresh",this,!b)
		}
	}
	...
	,getDateFromTick:function(d,f)
		...
		var h=c.data;
		var b=Sch.util.Date.add(h.start,Sch.util.Date.MILLI,e*(h.end-h.start));
		if(f)
			{
			b=this[f+"Date"](b)
		}
	...
	,floorDate:function(t,d,v)
		...
		switch(k)
			...
			break;
			case Sch.util.Date.MINUTE:if(d)
				{
			...
			break;
			case Sch.util.Date.WEEK:var r=n.getDay();
			Ext.Date.clearTime(n);
			...
			break;
			case Sch.util.Date.QUARTER:Ext.Date.clearTime(n);
			n.setDate(1);
			n=Sch.util.Date.add(n,Sch.util.Date.MONTH,-(n.getMonth()%3));
			break;
			case Sch.util.Date.YEAR:if(d)
				{
	...
	,roundDate:function(r)
		...
		switch(this.resolutionUnit)
			{
			case Sch.util.Date.MILLI:var e=Sch.util.Date.getDurationInMilliseconds(b,l),d=Math.round(e/s)*s;
			l=Sch.util.Date.add(b,Sch.util.Date.MILLI,d);
			break;
			case Sch.util.Date.SECOND:var i=Sch.util.Date.getDurationInSeconds(b,l),q=Math.round(i/s)*s;
			l=Sch.util.Date.add(b,Sch.util.Date.MILLI,q*1000);
			break;
			case Sch.util.Date.MINUTE:var n=Sch.util.Date.getDurationInMinutes(b,l),a=Math.round(n/s)*s;
			l=Sch.util.Date.add(b,Sch.util.Date.SECOND,a*60);
			break;
			case Sch.util.Date.HOUR:var m=Sch.util.Date.getDurationInHours(this.getStart(),l),j=Math.round(m/s)*s;
			l=Sch.util.Date.add(b,Sch.util.Date.MINUTE,j*60);
			break;
			case Sch.util.Date.DAY:var c=Sch.util.Date.getDurationInDays(b,l),f=Math.round(c/s)*s;
			l=Sch.util.Date.add(b,Sch.util.Date.DAY,f);
			break;
			case Sch.util.Date.WEEK:Ext.Date.clearTime(l);
			...
			break;
			case Sch.util.Date.MONTH:var p=Sch.util.Date.getDurationInMonths(b,l)+(l.getDate()/Ext.Date.getDaysInMonth(l)),h=Math.round(p/s)*s;
			l=Sch.util.Date.add(b,Sch.util.Date.MONTH,h);
			break;
			case Sch.util.Date.QUARTER:Ext.Date.clearTime(l);
			l.setDate(1);
			l=Sch.util.Date.add(l,Sch.util.Date.MONTH,3-(l.getMonth()%3));
			break;
			case Sch.util.Date.YEAR:var k=Sch.util.Date.getDurationInYears(b,l),g=Math.round(k/s)*s;
	...
	,ceilDate:function(c,b,f)
		...
		switch(d)
			{
			case Sch.util.Date.HOUR:if(e.getMinutes()>0||e.getSeconds()>0||e.getMilliseconds()>0)
				{
				g=true
			}
			break;
			case Sch.util.Date.DAY:if(e.getHours()>0||e.getMinutes()>0||e.getSeconds()>0||e.getMilliseconds()>0)
				{
				g=true
			}
			break;
			case Sch.util.Date.WEEK:Ext.Date.clearTime(e);
			if(e.getDay()!==this.weekStartDay)
				{
				g=true
			}
			break;
			case Sch.util.Date.MONTH:Ext.Date.clearTime(e);
			if(e.getDate()!==1)
				{
				g=true
			}
			break;
			case Sch.util.Date.QUARTER:Ext.Date.clearTime(e);
			if(e.getMonth()%3!==0)
				{
				g=true
			}
			break;
			case Sch.util.Date.YEAR:Ext.Date.clearTime(e);
	...
	,getResolution:function()
		{
		return	{
			unit:this.resolutionUnit,increment:this.resolutionIncrement
		}
	}
...
Ext.define("Sch.view.Horizontal",
	{
	requires:["Ext.util.Region","Ext.Element","Sch.util.Date"],view:null,constructor:function(a)
		{
		Ext.apply(this,a)
	}
	...
	,getScheduleRegion:function(e,g)
		...
		,d=this.translateToPageCoordinate(j.getXFromDate(b.start)),k=this.translateToPageCoordinate(j.getXFromDate(b.end)),h=i.top+j.barMargin,a=i.bottom-j.barMargin-j.eventBorderWidth;
				...
				if(b)
					...
					if(Ext.Element.prototype.fadeOut)
						...
						Ext.Anim.run(Ext.get(b),"fade",
							{
							out:true,duration:500,after:function()
								{
								g(c)
							}
							,autoClear:false
	...
	,getVisibleDateRange:function()
		...
		if((c.right-c.left)<e)
			{
			return				{
				startDate:b,endDate:f
			}
		}
		var a=d.getScroll();
		return			{
			startDate:d.getDateFromCoordinate(a.left,null,true),endDate:d.getDateFromCoordinate(a.left+e,null,true)
		}
	}
}
);
Ext.define("Sch.view.Vertical",
	...
	,getEventRenderData:function(a)
		{
		var g=a.getStartDate(),f=a.getEndDate(),i=this.view,e=i.timeAxis.getStart(),j=i.timeAxis.getEnd(),h=Math,d=h.floor(i.getCoordinateFromDate(Sch.util.Date.max(g,e))),k=h.floor(i.getCoordinateFromDate(Sch.util.Date.min(f,j))),c=this.getResourceColumnWidth(a.getResource()),b;
		b=
			{
			top:h.max(0,h.min(d,k)-i.eventBorderWidth),height:h.max(1,h.abs(d-k))
		};
	...
	,getScheduleRegion:function(d,f)
		...
		,c=this.translateToPageCoordinate(h.getCoordinateFromDate(Sch.util.Date.min(e,a.start))),j=this.translateToPageCoordinate(h.getCoordinateFromDate(Sch.util.Date.max(k,a.end))),b=g.left+h.barMargin,i=(d?(g.left+this.getResourceColumnWidth(d)):g.right)-h.barMargin;
		...
		if(c.length>0)
			...
			d++)
				...
				if(e)
					...
					g.push(
						{
						start:f.getStartDate(),end:f.getEndDate(),id:e.id
					}
					)
				}
			}
			...
			d++)
				...
				Ext.fly(f.id).setStyle(
					{
					left:f.left+"px",width:f.width+"px"
				}
				)
			}
		}
	...
	,getStartEndDatesFromRegion:function(d,c,b)
		...
		if(a&&e)
			{
			return				{
				start:Sch.util.Date.min(a,e),end:Sch.util.Date.max(a,e)
			}
		}
		else
			{
	...
	,getVisibleDateRange:function()
		...
		if(d.bottom-d.top<b)
			...
			return				{
				startDate:a,endDate:endDate
			}
		}
		return			{
			startDate:e.getDateFromCoordinate(c.top,null,true),endDate:e.getDateFromCoordinate(c.top+b,null,true)||f
		}
	}
}
);
Ext.define("Sch.selection.EventModel",
	{
	extend:"Ext.selection.Model",alias:"selection.eventmodel",requires:["Ext.util.KeyNav"],deselectOnContainerClick:true,selectedOnMouseDown:false,constructor:function(a)
		{
	...
	,bindComponent:function(a)
		...
		var b=this,c=
			{
			refresh:b.refresh,scope:b
		};
		b.view=a;
		b.bindStore(a.getEventStore());
		a.on(
			{
			eventclick:b.onEventClick,eventmousedown:b.onEventMouseDown,itemmousedown:b.onItemMouseDown,scope:this
		}
		);
		a.on(c)
	}
...
Ext.define("Sch.plugin.Printable",
	{
	extend:"Ext.AbstractPlugin",alias:"plugin.scheduler_printable",lockableScope:"top",docType:"<!DOCTYPE HTML>",beforePrint:Ext.emptyFn,afterPrint:Ext.emptyFn,autoPrintAndClose:true,fakeBackgroundColor:true,scheduler:null,constructor:function(a)
		{
		Ext.apply(this,a)
	}
	,init:function(a)
	...
	,mainTpl:new Ext.XTemplate('{docType	}<html class="'+Ext.baseCSSPrefix+'border-box {htmlClasses}"><head><meta content="text/html; charset=UTF-8" http-equiv="Content-Type" /><title>{title}</title>{styles}</head><body class="sch-print-body {bodyClasses}"><div class="sch-print-ct {componentClasses}" style="width:{totalWidth}px"><div class="sch-print-headerbg" style="border-left-width:{totalWidth}px;height:{headerHeight}px;"></div><div class="sch-print-header-wrap">{[this.printLockedHeader(values)]}{[this.printNormalHeader(values)]}</div>{[this.printLockedGrid(values)]}{[this.printNormalGrid(values)]}</div><script type="text/javascript">{setupScript}<\/script></body></html>',
		...
		printLockedHeader:function(a)
			...
			if(a.lockedGrid)
				{
				b+='<div style="left:-'+a.lockedScroll+"px;margin-right:-"+a.lockedScroll+"px;width:"+(a.lockedWidth+a.lockedScroll)+'px"';b+='class="sch-print-lockedheader '+a.lockedGrid.headerCt.el.dom.className+'">';b+=a.lockedHeader;b+="</div>"
			}
			return b
		}
		,printNormalHeader:function(a)
			...
			if(a.normalGrid)
				{
				b+='<div style="left:'+(a.lockedGrid?a.lockedWidth:"0")+"px;width:"+a.normalWidth+'px;" class="sch-print-normalheader '+a.normalGrid.headerCt.el.dom.className+'">';b+='<div style="margin-left:-'+a.normalScroll+'px">'+a.normalHeader+"</div>";b+="</div>";
			}
			return b;
		}
		,printLockedGrid:function(a)
			...
			if(a.lockedGrid)
				{
				b+='<div id="lockedRowsCt" style="left:-'+a.lockedScroll+"px;margin-right:-"+a.lockedScroll+"px;width:"+(a.lockedWidth+a.lockedScroll)+"px;top:"+a.headerHeight+'px;" class="sch-print-locked-rows-ct '+a.innerLockedClasses+" "+Ext.baseCSSPrefix+'grid-inner-locked">';b+=a.lockedRows;b+="</div>"
			}
			return b
		}
		,printNormalGrid:function(a)
			...
			if(a.normalGrid)
				{
				b+='<div id="normalRowsCt" style="left:'+(a.lockedGrid?a.lockedWidth:"0")+"px;top:"+a.headerHeight+"px;width:"+a.normalWidth+'px" class="sch-print-normal-rows-ct '+a.innerNormalClasses+'">';b+='<div style="position:relative;overflow:visible;margin-left:-'+a.normalScroll+'px">'+a.normalRows+"</div>";b+="</div>"
			}
			return b
		}
	}
	...
	,print:function()
		...
		var h=g.getView(),i=this.getStylesheets(),e=Ext.get(Ext.core.DomHelper.createDom(
			{
			tag:"div"
		}
		)),b;
		...
		var f=this.getGridContent(g),c=this.mainTpl.apply(Ext.apply(
			{
			waitText:this.waitText,docType:this.docType,htmlClasses:Ext.getBody().parent().dom.className,bodyClasses:Ext.getBody().dom.className,componentClasses:g.el.dom.className,title:(g.title||""),styles:b,totalWidth:g.getWidth(),setupScript:("window.onload = function(){("+this.setupScript.toString()+")("+g.syncRowHeight+", "+this.autoPrintAndClose+", "+Ext.isChrome+", "+Ext.isIE+");};")
		}
		,f));
...
Ext.define("Sch.plugin.Export",
	{
	extend:"Ext.util.Observable",alternateClassName:"Sch.plugin.PdfExport",alias:"plugin.scheduler_export",mixins:["Ext.AbstractPlugin"],requires:["Ext.XTemplate"],lockableScope:"top",printServer:undefined,tpl:null,exportDialogClassName:"Sch.widget.ExportDialog",exportDialogConfig:
		{
	}
	,defaultConfig:
		{
		format:"A4",orientation:"portrait",range:"complete",showHeader:true,singlePageExport:false
	}
	,expandAllBeforeExport:false,pageSizes:
		{
		A5:
			{
	...
	,openAfterExport:true,beforeExport:Ext.emptyFn,afterExport:Ext.emptyFn,fileFormat:"pdf",DPI:72,constructor:function(a)
		{
		a=a||
			{
		};
	...
	,showExportDialog:function()
		...
		b.win=Ext.create(b.exportDialogClassName,
			{
			plugin:b,exportDialogConfig:Ext.apply(
				{
				startDate:b.scheduler.getStart(),endDate:b.scheduler.getEnd(),rowHeight:a.rowHeight,columnWidth:a.timeAxisViewModel.getTickWidth(),defaultConfig:b.defaultConfig
			}
	...
	,saveRestoreData:function()
		...
		this.restoreSettings=
			{
			width:b.getWidth(),height:b.getHeight(),rowHeight:a.rowHeight,columnWidth:a.timeAxisViewModel.getTickWidth(),startDate:b.getStart(),endDate:b.getEnd(),normalWidth:c.getWidth(),normalLeft:c.getEl().getStyle("left"),lockedWidth:d.getWidth(),lockedCollapse:d.collapsed,normalCollapse:c.collapsed
		}
	}
	,getStylesheets:function()
		{
		var c=Ext.getDoc().select('link[rel="stylesheet"]'),a=Ext.get(Ext.core.DomHelper.createDom(
			{
			tag:"div"
		}
		)),b;
	...
	,doExport:function(n,j,q)
		...
		if(I.range!=="complete")
			...
			switch(I.range)
				{
				case"date":d=new Date(I.dateFrom);
				b=new Date(I.dateTo);
				...
				break;
				case"current":var L=r.getVisibleDateRange();
				d=L.startDate;
		...
		if(!I.singlePageExport)
			...
			z=K.getExportJsonHtml(h,
				{
				styles:m,config:I,ticks:J,skippedColsBefore:E,skippedColsAfter:k,printHeight:e,paperWidth:D,headerHeight:A
			}
			);
			C=I.format
		}
			...
			z=K.getExportJsonHtml(null,
				{
				styles:m,config:I,ticks:J,skippedColsBefore:E,skippedColsAfter:k,timeColumnWidth:t
			}
			);
		...
		if(K.printServer)
			...
			if(!K.debug&&!K.test)
				...
				Ext.Ajax.request(
					{
					type:"POST",url:K.printServer,timeout:60000,params:Ext.apply(
						{
						html:
							{
							array:z
						}
						,startDate:p.getStartDate(),endDate:p.getEndDate(),format:C,orientation:I.orientation,range:I.range,fileFormat:K.fileFormat
					}
					,this.getParameters()),success:function(a)
						{
						K.onSuccess(a,j,q)
					}
					,failure:function(a)
		...
		if(K.test)
			{
			return				{
				htmlArray:Ext.JSON.decode(z),calculatedPages:h
			}
		}
	}
	...
	,calculatePages:function(r,s,j,p,b)
		{
		var t=this,i=t.scheduler,q=i.lockedGrid,c=i.getSchedulingView().rowHeight,u=q.headerCt,o=u.getEl().first().getWidth(),h=null,k=0;
		if(o>q.getWidth())
			{
			...
			q.headerCt.items.each(function(y,w,v)
				...
				if(n)
					...
					h.push(
						{
						firstColumnIdx:g,lastColumnIdx:d,totalColumnsWidth:m||e
					}
					);
					g=d+1;
					m=0
		...
		return {
			columnsAmountLocked:k,columnsAmountNormal:l,lockedColumnPages:h,rowsAmount:f,rowPages:Math.ceil(i.getSchedulingView().store.getCount()/f),columnPages:a,timeColumnWidth:j,lockedGridWidth:o,rowHeight:c,panelHTML:
				{
			}
		}
	}
	,getExportJsonHtml:function(f,E)
		...
		if(!F.singlePageExport)
			...
			A++)
				...
				x+=1)
					...
					p=H.tpl.apply(Ext.apply(
						{
						bodyClasses:B,bodyHeight:c+z,componentClasses:q,styles:m,showHeader:F.showHeader,HTML:d.dom.innerHTML,totalWidth:C,headerHeight:z,column:A+1,row:x+1
					}
					));
					e=
						{
			...
			Ext.apply(o,
				{
				dom:n.body.dom.innerHTML,column:1,row:1,timeColumnWidth:E.timeColumnWidth,skippedColsBefore:E.skippedColsBefore,skippedColsAfter:E.skippedColsAfter
			}
			);
			d=H.resizePanelHTML(o);
			p=H.tpl.apply(Ext.apply(
				{
				bodyClasses:B,bodyHeight:w.height,componentClasses:q,styles:m,showHeader:false,HTML:d.dom.innerHTML,totalWidth:w.width
			}
			));
			e=
				{
	...
	,resizePanelHTML:function(f)
		...
		)),j=this.scheduler,d=j.lockedGrid,i=j.normalGrid,g,e,b;
...
Ext.define("Sch.plugin.Lines",
	{
	extend:"Sch.feature.AbstractTimeSpan",alias:"plugin.scheduler_lines",cls:"sch-timeline",showTip:true,innerTpl:null,prepareTemplateData:null,side:null,init:function(a)
		{
	...
	,getHeaderElementData:function(c)
		...
		f++)
			...
			if(b&&Sch.util.Date.betweenLesser(b,a,k))
				...
				g.push(Ext.apply(
					{
					id:this.getHeaderElementId(h),side:m?this.side:"top",cls:this.getHeaderElementCls(h,e),position:j
				}
				,e))
			}
		}
...
Ext.define("Sch.plugin.CurrentTimeLine",
	{
	extend:"Sch.plugin.Lines",alias:"plugin.scheduler_currenttimeline",mixins:["Sch.mixin.Localizable"],updateInterval:60000,showHeaderElements:true,autoUpdate:true,expandToFitView:true,timer:null,init:function(c)
		{
		var b=Ext.create("Ext.data.JsonStore",
			{
			fields:["Date","Cls","Text"],data:[
				{
...
Ext.define("Sch.plugin.DragSelector",
	{
	extend:"Sch.util.DragTracker",alias:"plugin.scheduler_dragselector",mixins:["Ext.AbstractPlugin"],lockableScope:"top",scheduler:null,schedulerView:null,eventData:null,sm:null,proxy:null,bodyRegion:null,constructor:function(a)
		{
		a=a||
			{
		};
		Ext.applyIf(a,
			{
			onBeforeStart:this.onBeforeStart,onStart:this.onStart,onDrag:this.onDrag,onEnd:this.onEnd
		}
		);
		this.callParent(arguments)
	}
	,init:function(a)
		...
		a.on(
			{
			afterrender:this.onSchedulerRender,destroy:this.onSchedulerDestroy,scope:this
		}
		);
		a.getSchedulingView().on(
			{
			afterrender:this.onSchedulingViewRender,scope:this
		}
		);
		this.scheduler=a
	}
...
Ext.define("Sch.plugin.EventEditor",
	...
	,initComponent:function()
		...
		Ext.apply(this,
			{
			fbar:this.buttons||this.buildButtons(),items:[
				{
	...
	,init:function(a)
		...
		this.schedulerView.on(
			{
			afterrender:this.onSchedulerRender,destroy:this.onSchedulerDestroy,dragcreateend:this.onDragCreateEnd,scope:this
		}
		);
	...
	,buildButtons:function()
		...
		this.saveButton=new Ext.Button(
			{
			text:this.L("saveText"),scope:this,handler:this.onSaveClick
		}
		);
		this.deleteButton=new Ext.Button(
			{
			text:this.L("deleteText"),scope:this,handler:this.onDeleteClick
		}
		);
		this.cancelButton=new Ext.Button(
			{
			text:this.L("cancelText"),scope:this,handler:this.onCancelClick
		}
		);
	...
	,buildDurationFields:function()
		...
		this.startDateField=new Ext.form.field.Date(Ext.apply(
			{
			width:90,allowBlank:false,format:this.dateFormat
		}
		,this.dateConfig||
			{
		}
		...
		this.startTimeField=new Ext.form.field.Time(Ext.apply(
			{
			width:70,allowBlank:false,format:this.timeFormat
		}
		,this.timeConfig||
			{
		}
		...
		this.durationField=new Ext.form.field.Number(Ext.apply(
			{
			width:45,value:0,minValue:0,allowNegative:false
		}
		,this.durationConfig||
			{
		}
...
Ext.define("Sch.plugin.EventTools",
	{
	extend:"Ext.Container",mixins:["Ext.AbstractPlugin"],lockableScope:"top",alias:"plugin.scheduler_eventtools",hideDelay:500,align:"right",defaults:
		{
		xtype:"tool",baseCls:"sch-tool",overCls:"sch-tool-over",width:20,height:20,visibleFn:Ext.emptyFn
	}
	,hideTimer:null,lastPosition:null,cachedSize:null,offset:
		{
		x:0,y:1
	}
	,autoRender:true,floating:true,hideMode:"offsets",hidden:true,getRecord:function()
		{
		return this.record
	}
	,init:function(a)
		...
		a.on(
			{
			eventresizestart:this.onOperationStart,eventresizeend:this.onOperationEnd,eventdragstart:this.onOperationStart,eventdrop:this.onOperationEnd,eventmouseenter:this.onEventMouseEnter,eventmouseleave:this.onContainerMouseLeave,scope:this
		}
		)
	}
	,onRender:function()
		...
		this.scheduler.mon(this.el,
			{
			mouseenter:this.onContainerMouseEnter,mouseleave:this.onContainerMouseLeave,scope:this
		}
		)
	}
...
Ext.define("Sch.plugin.Pan",
	{
	extend:"Ext.AbstractPlugin",alias:"plugin.scheduler_pan",lockableScope:"top",enableVerticalPan:true,statics:
		{
		KEY_SHIFT:1,KEY_CTRL:2,KEY_ALT:4,KEY_ALL:7
	}
	,disableOnKey:0,panel:null,constructor:function(a)
		{
		Ext.apply(this,a)
	}
	,init:function(a)
...
Ext.define("Sch.plugin.SimpleEditor",
	{
	extend:"Ext.Editor",alias:"plugin.scheduler_simpleeditor",mixins:["Ext.AbstractPlugin","Sch.mixin.Localizable"],lockableScope:"top",cls:"sch-simpleeditor",allowBlur:false,delegate:".sch-event-inner",dataIndex:null,completeOnEnter:true,cancelOnEsc:true,ignoreNoChange:true,height:19,autoSize:
		{
		width:"boundEl"
	}
	,constructor:function(a)
	...
	,onSchedulerRender:function(a)
		...
		this.on(
			{
			startedit:this.onBeforeEdit,complete:function(e,f,d)
				{
				var b=this.record;
...
Ext.define("Sch.plugin.SummaryColumn",
	{
	extend:"Ext.grid.column.Column",alias:["widget.summarycolumn","plugin.scheduler_summarycolumn"],mixins:["Ext.AbstractPlugin"],lockableScope:"top",showPercent:false,nbrDecimals:1,sortable:false,fixed:true,menuDisabled:true,width:80,dataIndex:"_sch_not_used",scheduler:null,eventStore:null,constructor:function(a)
		{
		this.scope=this;
		this.callParent(arguments)
	}
	...
	,renderer:function(j,a,f)
		{
		var h=this.scheduler,k=this.eventStore,e=h.getStart(),i=h.getEnd(),c=0,b=this.calculate(k.getEventsForResource(f),e,i);
		if(b<=0)
			{
			return""
		}
...
Ext.define("Sch.plugin.Zones",
	{
	extend:"Sch.feature.AbstractTimeSpan",alias:"plugin.scheduler_zones",requires:["Sch.model.Range"],innerTpl:null,cls:"sch-zone",side:null,init:function(a)
		{
		if(Ext.isString(this.innerTpl))
			{
			this.innerTpl=new Ext.XTemplate(this.innerTpl)
	...
	,getZoneHeaderElementData:function(b,h,f,a)
		...
		if(c&&Sch.util.Date.betweenLesser(c,b,h))
			...
			e=Ext.apply(
				{
				id:this.getHeaderElementId(f,a),cls:this.getHeaderElementCls(f,d,a),isStart:a,side:i?this.side:"top",position:g
			}
			,d)
		}
		return e
...
Ext.define("Sch.plugin.TimeGap",
	{
	extend:"Sch.plugin.Zones",alias:"plugin.scheduler_timegap",getZoneCls:Ext.emptyFn,init:function(a)
		{
		...
		a.mon(a.eventStore,
			{
			load:this.populateStore,update:this.populateStore,remove:this.populateStore,add:this.populateStore,datachanged:this.populateStore,scope:this
		}
		);
	...
	,populateStore:function(c)
		...
		while(j<i&&g<d)
			...
			if(!Sch.util.Date.betweenLesser(j,h,a.getEndDate())&&j<h)
				...
				f.push(new this.store.model(
					{
					StartDate:j,EndDate:h,Cls:this.getZoneCls(j,h)||""
				}
				))
			}
		...
		if(j<i)
			...
			f.push(new this.store.model(
				{
				StartDate:j,EndDate:i,Cls:this.getZoneCls(j,i)||""
			}
			))
		}
...
Ext.define("Sch.plugin.TreeCellEditing",
	{
	extend:"Ext.grid.plugin.CellEditing",alias:"plugin.scheduler_treecellediting",lockableScope:"locked",init:function(a)
		{
		this._grid=a;
	...
	,bindPositionFixer:function()
		...
		Ext.on(
			{
			afterlayout:this.fixEditorPosition,scope:this
		}
		)
	}
...
Ext.define("Sch.plugin.ResourceZones",
	{
	extend:"Sch.plugin.Zones",alias:"plugin.scheduler_resourcezones",innerTpl:null,store:null,cls:"sch-resourcezone",init:function(a)
		{
		this.uniqueCls=this.uniqueCls||("sch-timespangroup-"+Ext.id());
		this.scheduler=a;
		...
		this.storeListeners=
			{
			load:this.fullRefresh,datachanged:this.fullRefresh,clear:this.fullRefresh,add:this.fullRefresh,remove:this.fullRefresh,update:this.refreshSingle,addrecords:this.fullRefresh,removerecords:this.fullRefresh,updaterecord:this.refreshSingle,scope:this
		};
		this.store.on(this.storeListeners)
	}
	,onSchedulerDestroy:function()
		...
		a.each(function(i)
			...
			if(i.getResource()===f&&d&&g&&Sch.util.Date.intersectSpans(d,g,h,b))
				...
				e[e.length]=Ext.apply(
					{
					id:i.internalId,start:l,width:j,Cls:i.getCls()
				}
				,i.data)
			}
		}
	...
	,refreshSingle:function(i,g)
		...
		if(c)
			...
			c.setStyle(
				{
				left:h+"px",top:h+"px",height:a+"px",width:a+"px"
			}
			)
		}
	}
...
Ext.define("Sch.widget.ResizePicker",
	{
	extend:"Ext.Panel",alias:"widget.dualrangepicker",width:200,height:200,border:true,collapsible:false,bodyStyle:"position:absolute; margin:5px",verticalCfg:
		{
		height:120,value:24,increment:2,minValue:20,maxValue:80,reverse:true,disabled:true
	}
	,horizontalCfg:
		{
		width:120,value:100,minValue:25,increment:5,maxValue:200,disable:true
	}
	,initComponent:function()
		{
		var a=this;
		...
		a.dockedItems=[a.vertical=new Ext.slider.Single(Ext.apply(
			{
			dock:"left",style:"margin-top:10px",vertical:true,listeners:
				{
				change:a.onSliderChange,changecomplete:a.onSliderChangeComplete,scope:a
			}
		}
		,a.verticalCfg)),a.horizontal=new Ext.slider.Single(Ext.apply(
			{
			dock:"top",style:"margin-left:28px",listeners:
				{
				change:a.onSliderChange,changecomplete:a.onSliderChangeComplete,scope:a
			}
		}
...
Ext.define("Sch.widget.ExportDialogForm",
	{
	extend:"Ext.form.Panel",requires:["Ext.ProgressBar","Ext.form.field.ComboBox","Ext.form.field.Date","Ext.form.FieldContainer","Ext.form.field.Checkbox","Sch.widget.ResizePicker"],border:false,bodyPadding:"10 10 0 10",autoHeight:true,initComponent:function()
		{
		var a=this;
		...
		Ext.apply(this,
			...
			fieldDefaults:
				{
				labelAlign:"left",labelWidth:120,anchor:"99%"
			}
		...
		a.on(
			{
			hideprogressbar:a.hideProgressBar,showprogressbar:a.showProgressBar,updateprogressbar:a.updateProgressBar,scope:a
		}
		)
	}
	,isValid:function()
	...
	,createFields:function()
		...
		d.rangeField=new Ext.form.field.ComboBox(
			{
			value:a.defaultConfig.range,triggerAction:"all",cls:"sch-export-dialog-range",forceSelection:true,editable:false,fieldLabel:a.rangeFieldLabel,name:"range",queryMode:"local",displayField:"name",valueField:"value",store:Ext.create("Ext.data.Store",
				{
				...
				{
				change:d.onRangeChange,scope:d
			}
		}
		);
		d.resizePicker=new Sch.widget.ResizePicker(
			{
			dialogConfig:a,margin:"10 20"
		}
		);
		d.resizerHolder=new Ext.form.FieldContainer(
			{
			fieldLabel:a.scrollerDisabled?a.adjustCols:a.adjustColsAndRows,labelAlign:"top",hidden:true,labelSeparator:"",beforeLabelTextTpl:f,afterLabelTextTpl:e,layout:"vbox",defaults:
				{
		...
		d.dateFromField=new Ext.form.field.Date(
			{
			fieldLabel:a.dateRangeFromText,baseBodyCls:"sch-exportdialogform-date",name:"dateFrom",format:a.dateRangeFormat||Ext.Date.defaultFormat,allowBlank:false,maxValue:a.endDate,minValue:a.startDate,value:a.startDate
		}
		);
		d.dateToField=new Ext.form.field.Date(
			{
			fieldLabel:a.dateRangeToText,name:"dateTo",format:a.dateRangeFormat||Ext.Date.defaultFormat,baseBodyCls:"sch-exportdialogform-date",allowBlank:false,maxValue:a.endDate,minValue:a.startDate,value:a.endDate
		}
		);
		d.datesHolder=new Ext.form.FieldContainer(
			{
			fieldLabel:a.specifyDateRange,labelAlign:"top",hidden:true,labelSeparator:"",beforeLabelTextTpl:f,afterLabelTextTpl:e,layout:"vbox",defaults:
				{
				flex:1,allowBlank:false
			}
		...
		d.showHeaderField=new Ext.form.field.Checkbox(
			{
			xtype:"checkboxfield",boxLabel:d.dialogConfig.showHeaderLabel,name:"showHeader",checked:!!a.defaultConfig.showHeaderLabel
		}
		);
		d.exportToSingleField=new Ext.form.field.Checkbox(
			{
			xtype:"checkboxfield",boxLabel:d.dialogConfig.exportToSingleLabel,name:"singlePageExport",checked:!!a.defaultConfig.singlePageExport
		}
		);
		d.formatField=new Ext.form.field.ComboBox(
			{
			value:a.defaultConfig.format,triggerAction:"all",forceSelection:true,editable:false,fieldLabel:a.formatFieldLabel,name:"format",queryMode:"local",store:["A5","A4","A3","Letter","Legal"]
		}
		);
		...
		d.orientationField=new Ext.form.field.ComboBox(
			{
			value:a.defaultConfig.orientation,triggerAction:"all",baseBodyCls:"sch-exportdialogform-orientation",forceSelection:true,editable:false,fieldLabel:d.dialogConfig.orientationFieldLabel,afterSubTpl:new Ext.XTemplate('<span id="sch-exportdialog-imagePortrait" '+b+'></span><span id="sch-exportdialog-imageLandscape" '+c+"></span>"),name:"orientation",displayField:"name",valueField:"value",queryMode:"local",store:Ext.create("Ext.data.Store",
				{
				fields:["name","value"],data:[
					{
				...
				change:function(h,g)
					...
					switch(g)
						{
						case"landscape":Ext.fly("sch-exportdialog-imagePortrait").toggleCls("sch-none");
						Ext.fly("sch-exportdialog-imageLandscape").toggleCls("sch-none");
						break;
						case"portrait":Ext.fly("sch-exportdialog-imagePortrait").toggleCls("sch-none");
						Ext.fly("sch-exportdialog-imageLandscape").toggleCls("sch-none");
						break
					}
				}
	...
	,createProgressBar:function()
		...
		return this.progressBar=new Ext.ProgressBar(
			{
			text:this.config.progressBarText,animate:true,hidden:true,margin:"4px 0 10px 0"
		}
		)
	}
	,onRangeChange:function(b,a)
		...
		switch(a)
			{
			case"complete":this.datesHolder.hide();
			this.resizerHolder.hide();
			break;
			case"date":this.datesHolder.show();
			this.resizerHolder.hide();
			break;
			case"current":this.datesHolder.hide();
...
Ext.define("Sch.widget.ExportDialog",
	...
	alternateClassName:"Sch.widget.PdfExportDialog",extend:"Ext.window.Window",requires:["Sch.widget.ExportDialogForm"],mixins:["Sch.mixin.Localizable"],alias:"widget.exportdialog",modal:false,width:350,cls:"sch-exportdialog",frame:false,layout:"fit",draggable:true,padding:0,plugin:null,buttonsPanel:null,buttonsPanelScope:null,progressBar:null,dateRangeFormat:"",constructor:function(a)
		...
		this.config=Ext.apply(
			{
			progressBarText:this.L("progressBarText"),dateRangeToText:this.L("dateRangeToText"),pickerText:this.L("pickerText"),dateRangeFromText:this.L("dateRangeFromText"),dateRangeText:this.L("dateRangeText"),currentViewText:this.L("currentViewText"),formatFieldLabel:this.L("formatFieldLabel"),orientationFieldLabel:this.L("orientationFieldLabel"),rangeFieldLabel:this.L("rangeFieldLabel"),showHeaderLabel:this.L("showHeaderLabel"),exportToSingleLabel:this.L("exportToSingleLabel"),orientationPortraitText:this.L("orientationPortraitText"),orientationLandscapeText:this.L("orientationLandscapeText"),completeViewText:this.L("completeViewText"),adjustCols:this.L("adjustCols"),adjustColsAndRows:this.L("adjustColsAndRows"),specifyDateRange:this.L("specifyDateRange"),dateRangeFormat:this.dateRangeFormat,defaultConfig:this.defaultConfig
		}
	...
	,initComponent:function()
		...
		var b=this,a=
			{
			hidedialogwindow:b.destroy,showdialogerror:b.showError,updateprogressbar:function(c)
				{
		...
		Ext.apply(this,
			{
			items:b.form,fbar:b.buildButtons(b.buttonsPanelScope||b)
		}
		);
		b.callParent(arguments);
		b.plugin.on(a)
	...
	,buildForm:function(a)
		...
		return new Sch.widget.ExportDialogForm(
			{
			progressBar:this.progressBar,dialogConfig:a
		}
		)
	}
...
Ext.define("Sch.feature.ColumnLines",
	{
	extend:"Sch.plugin.Lines",cls:"sch-column-line",showTip:false,requires:["Ext.data.JsonStore"],init:function(a)
		{
		this.timeAxis=a.getTimeAxis();
		this.panel=a;
		this.store=new Ext.data.JsonStore(
		...
		a.on(
			{
			orientationchange:this.populate,destroy:this.onHostDestroy,scope:this
		}
		);
	...
	,getData:function()
		...
		if(a.isHorizontal())
			{
			this.timeAxis.forEachMainInterval(function(e,c,d)
				{
				if(d>0)
					{
					b.push(
...
Ext.define("Sch.mixin.TimelineView",
	{
	extend:"Sch.mixin.AbstractTimelineView",requires:["Sch.patches.ElementScroll"],overScheduledEventClass:"sch-event-hover",ScheduleEventMap:
		{
		click:"Click",mousedown:"MouseDown",mouseup:"MouseUp",dblclick:"DblClick",contextmenu:"ContextMenu",keydown:"KeyDown",keyup:"KeyUp"
	}
	...
	,setMouseOverEnabled:function(a)
		...
		this[a?"mon":"mun"](this.el,
			{
			mouseover:this.onEventMouseOver,mouseout:this.onEventMouseOut,delegate:this.eventSelector,scope:this
		}
		)
	}
	...
	,setupTooltip:function()
		...
		var b=this,a=Ext.apply(
			{
			renderTo:Ext.getBody(),delegate:b.eventSelector,target:b.el,anchor:"b",rtl:b.rtl,show:function()
				{
	...
	,setupTimeCellEvents:function()
		...
		this.mon(this.el,
			{
			click:this.handleScheduleEvent,dblclick:this.handleScheduleEvent,contextmenu:this.handleScheduleEvent,scope:this
		}
		)
	}
	,getTableRegion:function()
...
Ext.define("Sch.view.TimelineGridView",
	{
	extend:"Ext.grid.View",mixins:["Sch.mixin.TimelineView"]
}
,function()
	{
...
Ext.define("Sch.mixin.AbstractSchedulerView",
	...
	,bindEventStore:function(c,b)
		...
		var a=
			{
			scope:d,refresh:d.onEventDataRefresh,addrecords:d.onEventAdd,updaterecord:d.onEventUpdate,removerecords:d.onEventRemove,add:d.onEventAdd,update:d.onEventUpdate,remove:d.onEventRemove
		};
		if(!Ext.versions.touch)
			{
...
Ext.define("Sch.mixin.SchedulerView",
	...
	,inheritables:function()
		{
		return			{
			loadingText:"Loading events...",overItemCls:"",setReadOnly:function(a)
				{
				if(this.dragCreator)
					{
			...
			,onUnbindStore:function(a)
				...
				a.un(
					{
					refresh:this.clearRowHeightCache,clear:this.clearRowHeightCache,load:this.clearRowHeightCache,scope:this
				}
				);
				this.callParent(arguments)
			}
			,bindStore:function(a,b,c)
				{
				a&&a.on(
					{
					refresh:this.clearRowHeightCache,clear:this.clearRowHeightCache,load:this.clearRowHeightCache,scope:this
	...
	,configureFunctionality:function()
		...
		if(this.eventResizeHandles!=="none"&&Sch.feature.ResizeZone)
			...
			this.resizePlug=new Sch.feature.ResizeZone(Ext.applyIf(
				{
				schedulerView:this,validatorFn:function(d,c,b,e)
					{
		...
		if(this.enableDragCreation!==false&&Sch.feature.DragCreator)
			...
			this.dragCreator=new Sch.feature.DragCreator(Ext.applyIf(
				{
				schedulerView:this,disabled:this.readOnly,validatorFn:function(c,b,d)
					{
...
Ext.define("Sch.view.SchedulerGridView",
	{
	extend:"Sch.view.TimelineGridView",mixins:["Sch.mixin.SchedulerView","Sch.mixin.Localizable"],alias:"widget.schedulergridview"
}
,function()
	{
...
Ext.define("Sch.mixin.Zoomable",
	...
	,presetToZoomLevel:function(e)
		...
		var b=c.middle;
		return			{
			preset:e,increment:(a?a.increment:b.increment)||1,resolution:d.timeResolution.increment,resolutionUnit:d.timeResolution.unit,width:d.timeColumnWidth
		}
	}
	...
	,zoomToLevel:function(b,s)
		{
		b=Ext.Number.constrain(b,this.minZoomLevel,this.maxZoomLevel);
		var r=this.calculateCurrentZoomLevel();
		var e=this.getMilliSecondsPerPixelForZoomLevel(r);
		var m=this.zoomLevels[b];
		var a=this.getMilliSecondsPerPixelForZoomLevel(m);
		if(e==a&&!s)
			{
			return null
		}
		var u=this;
		var n=this.getSchedulingView();
		var h=n.getOuterEl();
		var t=n.getScrollEventSource();
		if(this.isFirstZoom)
			{
			this.isFirstZoom=false;
			t.on("scroll",this.clearCenterDateCache,this)
		}
		var j=this.orientation=="vertical";
		var g=s?new Date((s.start.getTime()+s.end.getTime())/2):this.getViewportCenterDateCached();
		var o=j?h.getHeight():h.getWidth();
		var p=Ext.clone(Sch.preset.Manager.getPreset(m.preset));
		var f=Boolean(s);
		s=s||this.calculateOptimalDateRange(g,o,m);
		var c=p.headerConfig;
		var i=c.bottom;
		var v=c.middle;
		p[j?"rowHeight":"timeColumnWidth"]=m.width;
		if(i)
			{
			i.increment=m.increment
		}
		else
			{
			v.increment=m.increment
		}
		this.isZooming=true;
		this.viewPreset=m.preset;
		var q=i?i.unit:v.unit;
		var d=this.timeAxis;
		d.reconfigure(
			{
			preset:p,headerConfig:c,unit:q,increment:m.increment,resolutionUnit:Sch.util.Date.getUnitByName(m.resolutionUnit||q),resolutionIncrement:m.resolution,weekStartDay:this.weekStartDay,mainUnit:v.unit,shiftUnit:p.shiftUnit,shiftIncrement:p.shiftIncrement||1,defaultSpan:p.defaultSpan||1,start:s.start||this.getStart(),end:s.end||this.getEnd()
		}
		);
		if(f)
			{
			g=new Date((d.getStart().getTime()+d.getEnd().getTime())/2)
		}
		t.on("scroll",function()
			{
			u.cachedCenterDate=g
		}
		,this,
			{
			single:true
		...
		if(j)
			{
			var k=n.getYFromDate(g,true);
			n.scrollVerticallyTo(k-o/2)
		}
		else
			{
			var l=n.getXFromDate(g,true);
			n.scrollHorizontallyTo(l-o/2)
		}
		u.isZooming=false;
	...
	,zoomToSpan:function(r,u)
		...
		if(r.start&&r.end&&r.start<r.end)
			...
			,
				{
				adjustStart:1,adjustEnd:1
			}
			);
			var f=r.start,e=r.end,h=function(w)
				{
				return w
			}
			,t=h,s=h;
			...
			var b=s(e,this.timeAxis.mainUnit,this.timeAxis)-t(f,this.timeAxis.mainUnit,this.timeAxis),n=this.getMilliSecondsPerPixelForZoomLevel(this.zoomLevels[l]),k=b/n>q?-1:1,a=l+k,j=this.orientation=="vertical"?"rowHeight":"timeColumnWidth";
			var o,p,m,g=null,c=this.timeAxis.mainUnit;
			while(a>=0&&a<=this.zoomLevels.length-1)
				...
				Ext.apply(d,
					{
					autoAdjust:this.timeAxis.autoAdjust,preset:p,headerConfig:p.headerConfig,unit:m,increment:o.increment,resolutionUnit:Sch.util.Date.getUnitByName(o.resolutionUnit||m),resolutionIncrement:o.resolution,mainUnit:v.unit,shiftUnit:p.shiftUnit,shiftIncrement:p.shiftIncrement||1,defaultSpan:p.defaultSpan||1
				}
				);
				b=s(e,m,d)-t(f,m,d);
	...
	,calculateOptimalDateRange:function(c,i,e)
		{
		var h=this.timeAxis;
		if(this.zoomKeepsOriginalTimespan)
			{
			return				{
				start:h.getStart(),end:h.getEnd()
			}
		}
		var b=Sch.util.Date;
		...
		var g=b.add(c,k,d);
		return			{
			start:h.floorDate(a,false,f),end:h.ceilDate(g,false,f)
		}
	}
}
);
Ext.define("Sch.mixin.AbstractTimelinePanel",
	{
	requires:["Sch.data.TimeAxis","Sch.view.model.TimeAxis","Sch.feature.ColumnLines","Sch.preset.Manager"],mixins:["Sch.mixin.Zoomable"],orientation:"horizontal",weekStartDay:1,snapToIncrement:false,readOnly:false,forceFit:false,eventResizeHandles:"both",timeAxis:null,autoAdjustTimeAxis:true,timeAxisViewModel:null,viewPreset:"weekAndDay",trackHeaderOver:true,startDate:null,endDate:null,columnLines:true,trackMouseOver:false,readRowHeightFromPreset:true,eventBorderWidth:1,getOrientation:function()
		{
		return this.orientation
	}
	,isHorizontal:function()
	...
	,cellBorderWidth:1,cellTopBorderWidth:1,cellBottomBorderWidth:1,_initializeTimelinePanel:function()
		{
		...
		if(!this.timeAxisViewModel||!(this.timeAxisViewModel instanceof Sch.view.model.TimeAxis))
			...
			var a=Ext.apply(
				{
				snapToIncrement:this.snapToIncrement,forceFit:this.forceFit,timeAxis:this.timeAxis
			}
	...
	,switchViewPreset:function(d,a,f,b)
		...
		if(b&&this.timeAxis.preset)
			{
			this.applyViewSettings(this.timeAxis.preset,b);
			return
		}
	...
	,applyViewSettings:function(d,c)
		{
		var b=this.getSchedulingView();
		b.setDisplayDateFormat(d.displayDateFormat);
		if(this.orientation==="horizontal")
			{
			b.setRowHeight(this.readRowHeightFromPreset?d.rowHeight:this.rowHeight,true)
		}
		else
			{
			var a=d.timeColumnWidth||60;
			b.setRowHeight(a,true);
			b.setColumnWidth(this.resourceColumnWidth||d.resourceColumnWidth||100,true)
		}
	}
	,getStart:function()
		{
	...
	,onTimeAxisReconfigure:function(a)
		{
		this.applyViewSettings(a.preset);
...
Ext.define("Sch.mixin.TimelinePanel",
	{
	extend:"Sch.mixin.AbstractTimelinePanel",requires:["Sch.util.Patch","Sch.column.timeAxis.Horizontal","Sch.preset.Manager"],mixins:["Sch.mixin.Zoomable","Sch.mixin.Lockable"],tipCfg:
		{
		cls:"sch-tip",showDelay:1000,hideDelay:0,autoHide:true,anchor:"b"
	}
	,inheritables:function()
		{
		return			{
			columnLines:true,enableLocking:true,lockable:true,initComponent:function()
				{
				...
				Ext.apply(this.normalViewConfig,
					{
					id:c+"-timelineview",eventPrefix:this.autoGenId?null:c,timeAxisViewModel:this.timeAxisViewModel,eventBorderWidth:this.eventBorderWidth,timeAxis:this.timeAxis,readOnly:this.readOnly,orientation:this.orientation,rtl:this.rtl,cellBorderWidth:this.cellBorderWidth,cellTopBorderWidth:this.cellTopBorderWidth,cellBottomBorderWidth:this.cellBottomBorderWidth
				}
				);
				Ext.Array.forEach(["eventRendererScope","eventRenderer","dndValidatorFn","resizeValidatorFn","createValidatorFn","tooltipTpl","validatorFnScope","snapToIncrement","eventResizeHandles","enableEventDragDrop","enableDragCreation","resizeConfig","createConfig","tipCfg","getDateConstraints"],function(d)
					{
					if(d in this)
						{
						b[d]=this[d]
			...
			,getState:function()
				...
				Ext.apply(b,
					{
					viewPreset:a.viewPreset,startDate:a.getStart(),endDate:a.getEnd(),zoomMinLevel:a.zoomMinLevel,zoomMaxLevel:a.zoomMaxLevel,currentZoomLevel:a.currentZoomLevel
				}
				);
				return b
			}
	...
	,configureColumns:function()
		...
		Ext.Array.insert(a,0,c.concat(
			{
			xtype:"timeaxiscolumn",timeAxisViewModel:this.timeAxisViewModel,trackHeaderOver:this.trackHeaderOver,renderer:this.mainRenderer,scope:this
		}
		).concat(b));
		this.horizontalColumns=Ext.Array.clone(a);
		this.verticalColumns=[Ext.apply(
			{
			xtype:"verticaltimeaxis",width:100,timeAxis:this.timeAxis,timeAxisViewModel:this.timeAxisViewModel,cellTopBorderWidth:this.cellTopBorderWidth,cellBottomBorderWidth:this.cellBottomBorderWidth
		}
	...
	,mainRenderer:function(b,m,f,j,l)
		{
		var g=this.renderers,k=this.orientation==="horizontal",c=k?f:this.resourceStore.getAt(l),a="&nbsp;";
		m.rowHeight=null;
		for(var d=0;
		d<g.length;
		d++)
	...
	,__onAfterRender:function()
		...
		a.normalGrid.on(
			{
			collapse:a.onNormalGridCollapse,expand:a.onNormalGridExpand,scope:a
		}
		);
		a.lockedGrid.on(
			{
			collapse:a.onLockedGridCollapse,itemdblclick:a.onLockedGridItemDblClick,scope:a
		}
		);
	...
	,setupPartnerTimelinePanel:function()
		...
		var a=this.partnerTimelinePanel.getSchedulingView().getEl(),e=this.getSchedulingView().getEl();
		this.partnerTimelinePanel.mon(e,"scroll",function(h,g)
			{
...
Ext.define("Sch.mixin.AbstractSchedulerPanel",
	{
	requires:["Sch.model.Event","Sch.model.Resource","Sch.data.EventStore","Sch.data.ResourceStore","Sch.util.Date"],eventBarIconClsField:"",enableEventDragDrop:true,resourceColumnClass:"Sch.column.Resource",resourceColumnWidth:null,allowOverlap:true,startParamName:"startDate",endParamName:"endDate",passStartEndParameters:false,variableRowHeight:true,eventRenderer:null,eventRendererScope:null,eventStore:null,resourceStore:null,onEventCreated:function(a)
		{
	}
	,initStores:function()
		{
	...
	,createResourceColumns:function(b)
		...
		this.resourceStore.each(function(d)
			...
			a.push(Ext.create(this.resourceColumnClass,
				{
				renderer:c.mainRenderer,scope:c,width:b||100,text:d.getName(),model:d
			}
			))
		}
		,this);
...
Ext.define("Sch.mixin.SchedulerPanel",
	{
	extend:"Sch.mixin.AbstractSchedulerPanel",requires:["Sch.view.SchedulerGridView","Sch.selection.EventModel","Sch.plugin.ResourceZones","Sch.column.timeAxis.Vertical"],eventSelModelType:"eventmodel",eventSelModel:null,enableEventDragDrop:true,enableDragCreation:true,dragConfig:null,resourceZones:null,resourceZonesConfig:null,componentCls:"sch-schedulerpanel",lockedGridDependsOnSchedule:true,inheritables:function()
		{
		return			{
			initComponent:function() {
				var b=this.normalViewConfig=this.normalViewConfig||
				...
				Ext.apply(b,
					{
					eventStore:this.eventStore,resourceStore:this.resourceStore,eventBarTextField:this.eventBarTextField||this.eventStore.model.prototype.nameField
				}
				);
				Ext.Array.forEach(["barMargin","eventBodyTemplate","eventTpl","allowOverlap","dragConfig","eventBarIconClsField","onEventCreated","constrainDragToResource"],function(e)
					{
					if(e in this)
						{
						b[e]=this[e]
				...
				if(this.orientation==="vertical")
					...
					this.mon(this.resourceStore,
						{
						clear:this.refreshResourceColumns,datachanged:this.refreshResourceColumns,update:this.refreshResourceColumns,load:this.refreshResourceColumns,scope:this
					}
					)
				}
				this.callParent(arguments);
	...
	,enableRowHeightInjection:function(a,c)
		...
		var b=new Ext.XTemplate("{%","this.processCellValues(values);","this.nextTpl.applyOut(values, out, parent);","%}",
			{
			priority:1,processCellValues:function(e)
				{
	...
	,getEventSelectionModel:function()
		...
		Ext.applyIf(a,
			{
			allowDeselect:this.allowDeselect,mode:b
		}
		);
		if(!a.events)
			{
	...
	,refreshResourceColumns:function()
		...
		a.suspendLayouts();
		a.removeAll();
		a.add(this.createResourceColumns(this.resourceColumnWidth||this.timeAxis.preset.resourceColumnWidth));
		a.resumeLayouts();
	...
	,setOrientation:function(a,d)
		...
		if(a==="horizontal")
			...
			c.mun(c.resourceStore,
				{
				clear:c.refreshResourceColumns,datachanged:c.refreshResourceColumns,load:c.refreshResourceColumns,scope:c
			}
			);
			...
			c.reconfigure(c.timeAxis,c.verticalColumns.concat(c.createResourceColumns(c.resourceColumnWidth||c.timeAxis.preset.resourceColumnWidth)));
...
Ext.define("Sch.panel.TimelineGridPanel",
	{
	extend:"Ext.grid.Panel",mixins:["Sch.mixin.TimelinePanel"],subGridXType:"gridpanel",requires:["Sch.patches.ColumnResize"],initComponent:function()
		{
		this.callParent(arguments);
...
Ext.define("Sch.panel.TimelineTreePanel",
	{
	extend:"Ext.tree.Panel",requires:["Ext.grid.Panel","Ext.data.TreeStore","Sch.mixin.FilterableTreeView","Sch.patches.ColumnResizeTree"],mixins:["Sch.mixin.TimelinePanel"],useArrows:true,rootVisible:false,lockedXType:"treepanel",initComponent:function()
		{
		this.callParent(arguments);
		this.getSchedulingView()._initializeTimelineView()
	}
...
Ext.define("Sch.panel.SchedulerGrid",
	{
	extend:"Sch.panel.TimelineGridPanel",mixins:["Sch.mixin.SchedulerPanel"],alias:["widget.schedulergrid","widget.schedulerpanel"],alternateClassName:"Sch.SchedulerPanel",viewType:"schedulergridview",initComponent:function()
		{
		this.callParent(arguments);
...
Ext.define("Sch.panel.SchedulerTree",
	{
	extend:"Sch.panel.TimelineTreePanel",mixins:["Sch.mixin.SchedulerPanel"],alias:["widget.schedulertree"],viewType:"schedulergridview",setOrientation:function(a)
		{
		if(a=="vertical")
			{
