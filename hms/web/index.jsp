        ...
        <div class="row" id="maincontent" style="margin-top: 5px; height: 99%">
            ...
            <div class="col-md-13" id="centercontent" style="height: 100%;">
                <div class="panel panel-default" id='mainpanel0' style="height: 654px; background-color: <%=bgcol%>;">
                    <div class="panel-heading  panel-title" style="text-align: center; height: 31px; background-color: darkgray !important;">
                        <span class="pull-left">
                            <ul class="nav nav-tabs toptab" role="tablist" id='maintabs' style="padding-top: 0px; padding-left: 0px; padding-bottom: 0px;"></ul>
                        </span>
                    </div>
                    ...
                    <div class="panel-body">
                        <form role="form" method="post">
                            <div class="form-group">
                                <input class="form-control" placeholder="სარეგისტრაციო სახელი" type="text" name="loginid" id="loginid">
                            </div>
                            <div class="form-group">
                                <input class="form-control" id="password" name="password" placeholder="პაროლი" type="password">
                            </div>
                            <button type="submit" name="login" id="login" class="active btn btn-block btn-lg btn-primary">შესვლა</button>
                        </form>
                    </div>
                </div>
            </div>
...
<div class="modal fade modal-vertical-centered" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header" style="background-color: gray; color: white; height: 30px;">
        <button type="button" id="myModalbtn" class="close" data-dismiss="modal" aria-hidden="true" style='margin-top: -6px;'>&times;</button>
      ...
      <div class="modal-footer" id="myModalFooter">
        ...
        <button type="button" class="btn btn-primary" id="myModalSave" onclick="savedata('myModal')">შენახვა</button>
      </div>
    </div>
  </div>
</div>
    
<div class="modal fade modal-vertical-centered" id="smallmodal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
...
<div class="modal fade modal-vertical-centered" id="mediummodal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
  <div class="modal-dialog modal-ex">
    <div class="modal-content">
        <div class="modal-header" style="background-color: gray; color: white; height: 30px;">
            <button type="button" id="mediummodalbtn" class="close" data-dismiss="modal" aria-hidden="true" style='margin-top: -6px;'>&times;</button>
            <h4 id="mdheader" style='margin-top: -4px;'></h4>
      </div>
      <div class="modal-body" id="mdbody"></div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" id='mediummodalclose' data-dismiss="modal">დახურვა</button>
        <button type="button" class="btn btn-primary" id='mediummodalsave' onclick="savedata('mediummodal')">შენახვა</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade modal-vertical-centered" id="infomodal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
        <div class="modal-header" style="background-color: gray; color: white; height: 30px;">
            <button type="button" id="infomodal" class="close" data-dismiss="modal" aria-hidden="true" style='margin-top: -6px;'>&times;</button>
...
<div class="modal fade modal-vertical-centered" id="extramodal0" tabindex="-1" role="dialog" aria-labelledby="extramodal0Label" aria-hidden="true">
  <div class="modal-dialog modal-ex">
    <div class="modal-content">
      <div class="modal-header" style="background-color: green; color: white; height: 30px;">
        <button type="button" id="extramodal0" class="close" data-dismiss="modal" aria-hidden="true" style='margin-top: -6px;'>&times;</button>
...
<div id="contextMenu" class="dropdown clearfix" style="z-index: 300000;">
    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu" style="display:block;position:static;margin-bottom:5px;">
        ...
        %>
        <li class="roomlistitm"><a id="<%=cmenufiles[i]%>" icon="<%=cmenuicons[i]%>" href="#"><%=cmenunames[i]%></a></li>
        <%
        }
        %>
    </ul>
